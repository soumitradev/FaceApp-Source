...
public class ArchTaskExecutor extends TaskExecutor {
    @NonNull
    private static final Executor sIOThreadExecutor = new C00852();
    private static volatile ArchTaskExecutor sInstance;
    @NonNull
    private static final Executor sMainThreadExecutor = new C00841();
    @NonNull
    ...
    static class C00841 implements Executor {
        C00841() {
        }
    ...
    static class C00852 implements Executor {
        C00852() {
        }
