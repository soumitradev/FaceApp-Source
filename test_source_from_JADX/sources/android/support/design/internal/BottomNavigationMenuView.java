...
public class BottomNavigationMenuView extends ViewGroup implements MenuView {
    ...
    public BottomNavigationMenuView(Context context, AttributeSet attrs) {
        ...
        this.mInactiveItemMaxWidth = res.getDimensionPixelSize(C0002R.dimen.design_bottom_navigation_item_max_width);
        this.mInactiveItemMinWidth = res.getDimensionPixelSize(C0002R.dimen.design_bottom_navigation_item_min_width);
        this.mActiveItemMaxWidth = res.getDimensionPixelSize(C0002R.dimen.design_bottom_navigation_active_item_max_width);
        this.mItemHeight = res.getDimensionPixelSize(C0002R.dimen.design_bottom_navigation_height);
        ...
        this.mOnClickListener = new C01011();
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (inactiveCount = 0; inactiveCount < count; inactiveCount++) {
            ...
            if (child.getVisibility() != 8) {
                child.measure(MeasureSpec.makeMeasureSpec(r0.mTempChildWidths[inactiveCount], Ints.MAX_POWER_OF_TWO), heightSpec);
                child.getLayoutParams().width = child.getMeasuredWidth();
                totalWidth += child.getMeasuredWidth();
            }
        }
        setMeasuredDimension(View.resolveSizeAndState(totalWidth, MeasureSpec.makeMeasureSpec(totalWidth, Ints.MAX_POWER_OF_TWO), 0), View.resolveSizeAndState(r0.mItemHeight, heightSpec, 0));
    }
