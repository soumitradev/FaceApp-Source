...
public class NavigationMenuItemView extends ForegroundLinearLayout implements MenuView$ItemView {
    ...
    class C06751 extends AccessibilityDelegateCompat {
        C06751() {
        }
    ...
    public NavigationMenuItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mAccessibilityDelegate = new C06751();
        setOrientation(0);
        LayoutInflater.from(context).inflate(C0002R.layout.design_navigation_menu_item, this, true);
        this.mIconSize = context.getResources().getDimensionPixelSize(C0002R.dimen.design_navigation_icon_size);
    ...
    private StateListDrawable createDefaultBackground() {
        ...
        if (!getContext().getTheme().resolveAttribute(C0034R.attr.colorControlHighlight, value, true)) {
            return null;
        }
