...
public class ScrimInsetsFrameLayout extends FrameLayout {
    ...
    class C06761 implements OnApplyWindowInsetsListener {
        C06761() {
        }
    ...
    public ScrimInsetsFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0002R.styleable.ScrimInsetsFrameLayout, defStyleAttr, C0002R.style.Widget_Design_ScrimInsetsFrameLayout);
        this.mInsetForeground = a.getDrawable(C0002R.styleable.ScrimInsetsFrameLayout_insetForeground);
        a.recycle();
        setWillNotDraw(true);
        ViewCompat.setOnApplyWindowInsetsListener(this, new C06761());
    }
