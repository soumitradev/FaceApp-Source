...
public class BottomNavigationView extends FrameLayout {
    ...
    class C06771 implements Callback {
        C06771() {
        }
    ...
    static class SavedState extends AbsSavedState {
        ...
        static class C01061 implements ClassLoaderCreator<SavedState> {
            C01061() {
            }
    ...
    public BottomNavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0002R.styleable.BottomNavigationView, defStyleAttr, C0002R.style.Widget_Design_BottomNavigationView);
        if (a.hasValue(C0002R.styleable.BottomNavigationView_itemIconTint)) {
            this.mMenuView.setIconTintList(a.getColorStateList(C0002R.styleable.BottomNavigationView_itemIconTint));
        } else {
            this.mMenuView.setIconTintList(createDefaultColorStateList(16842808));
        }
        if (a.hasValue(C0002R.styleable.BottomNavigationView_itemTextColor)) {
            this.mMenuView.setItemTextColor(a.getColorStateList(C0002R.styleable.BottomNavigationView_itemTextColor));
        } else {
            this.mMenuView.setItemTextColor(createDefaultColorStateList(16842808));
        }
        if (a.hasValue(C0002R.styleable.BottomNavigationView_elevation)) {
            ViewCompat.setElevation(this, (float) a.getDimensionPixelSize(C0002R.styleable.BottomNavigationView_elevation, 0));
        }
        this.mMenuView.setItemBackgroundRes(a.getResourceId(C0002R.styleable.BottomNavigationView_itemBackground, 0));
        if (a.hasValue(C0002R.styleable.BottomNavigationView_menu)) {
            inflateMenu(a.getResourceId(C0002R.styleable.BottomNavigationView_menu, 0));
        }
        a.recycle();
        ...
        this.mMenu.setCallback(new C06771());
    }
    ...
    private void addCompatibilityTopDivider(Context context) {
        ...
        divider.setLayoutParams(new LayoutParams(-1, getResources().getDimensionPixelSize(C0002R.dimen.design_bottom_navigation_shadow_height)));
        addView(divider);
    }
