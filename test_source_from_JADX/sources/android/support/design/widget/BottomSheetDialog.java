...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    class C01083 implements OnTouchListener {
        C01083() {
        }
    ...
    class C06782 extends AccessibilityDelegateCompat {
        C06782() {
        }
    ...
    class C06794 extends BottomSheetCallback {
        C06794() {
        }
    ...
    public BottomSheetDialog(@NonNull Context context, @StyleRes int theme) {
        ...
        this.mBottomSheetCallback = new C06794();
    ...
    private View wrapInBottomSheet(int layoutResId, View view, LayoutParams params) {
        FrameLayout container = (FrameLayout) View.inflate(getContext(), C0002R.layout.design_bottom_sheet_dialog, null);
        ...
        coordinator.findViewById(R$id.touch_outside).setOnClickListener(new C01071());
        ViewCompat.setAccessibilityDelegate(bottomSheet, new C06782());
        bottomSheet.setOnTouchListener(new C01083());
        return container;
    }
    ...
    private static int getThemeResId(Context context, int themeId) {
        ...
        if (context.getTheme().resolveAttribute(C0002R.attr.bottomSheetDialogTheme, outValue, true)) {
            return outValue.resourceId;
        }
        return C0002R.style.Theme_Design_Light_BottomSheetDialog;
    }
}
