...
import android.support.coreui.C0001R;
...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        LayoutParams(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray a = context.obtainStyledAttributes(attrs, C0001R.styleable.CoordinatorLayout_Layout);
            ...
            if (this.mBehaviorResolved) {
                this.mBehavior = CoordinatorLayout.parseBehavior(context, attrs, a.getString(C0001R.styleable.CoordinatorLayout_Layout_layout_behavior));
            }
            a.recycle();
    ...
    class C00531 implements OnApplyWindowInsetsListener {
        C00531() {
        }
    ...
    protected static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = new CoordinatorLayout$SavedState$1();
    ...
    public CoordinatorLayout(Context context, AttributeSet attrs) {
        this(context, attrs, C0001R.attr.coordinatorLayoutStyle);
    }
    ...
    public CoordinatorLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int i = 0;
        if (defStyleAttr == 0) {
            a = context.obtainStyledAttributes(attrs, C0001R.styleable.CoordinatorLayout, 0, C0001R.style.Widget_Support_CoordinatorLayout);
        } else {
            a = context.obtainStyledAttributes(attrs, C0001R.styleable.CoordinatorLayout, defStyleAttr, 0);
        }
        ...
        if (VERSION.SDK_INT >= 21) {
            if (ViewCompat.getFitsSystemWindows(this)) {
                if (this.mApplyWindowInsetsListener == null) {
                    this.mApplyWindowInsetsListener = new C00531();
                }
