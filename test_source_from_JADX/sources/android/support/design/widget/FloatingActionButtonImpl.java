...
class FloatingActionButtonImpl {
    ...
    void hide(@Nullable InternalVisibilityChangedListener listener, boolean fromUser) {
        if (!isOrWillBeHidden()) {
            ...
            if (shouldAnimateVisibilityChange()) {
                this.mAnimState = 1;
                this.mView.animate().scaleX(0.0f).scaleY(0.0f).alpha(0.0f).setDuration(200).setInterpolator(AnimationUtils.FAST_OUT_LINEAR_IN_INTERPOLATOR).setListener(new FloatingActionButtonImpl$1(this, fromUser, listener));
            } else {
    ...
    void show(@Nullable InternalVisibilityChangedListener listener, boolean fromUser) {
        if (!isOrWillBeShown()) {
            ...
            if (shouldAnimateVisibilityChange()) {
                ...
                this.mView.animate().scaleX(1.0f).scaleY(1.0f).alpha(1.0f).setDuration(200).setInterpolator(AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR).setListener(new FloatingActionButtonImpl$2(this, fromUser, listener));
            } else {
    ...
    private void ensurePreDrawListener() {
        if (this.mPreDrawListener == null) {
            this.mPreDrawListener = new FloatingActionButtonImpl$3(this);
        }
    }
