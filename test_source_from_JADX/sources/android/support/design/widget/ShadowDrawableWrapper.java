...
class ShadowDrawableWrapper extends DrawableWrapper {
    ...
    private void drawShadow(Canvas canvas) {
        ...
        float shadowScaleBottom2 = shadowOffset / (shadowOffset + (r0.mRawShadowSize - (r0.mRawShadowSize * 1.0f)));
        ...
        if (drawHorizontalEdges) {
            ...
            canvas2.drawRect(0.0f, edgeShadowTop, r0.mContentBounds.width() - (shadowOffset * 2.0f), -r0.mCornerRadius, r0.mEdgeShadowPaint);
        } else {
            shadowScaleBottom = shadowScaleBottom2;
            shadowScaleTop = shadowScaleTop2;
            shadowScaleHorizontal = shadowScaleHorizontal2;
            float f = shadowOffsetTop;
            float f2 = shadowOffsetHorizontal;
            shadowOffsetHorizontal = 1.0f;
            saved = saved2;
        }
        ...
        if (drawHorizontalEdges) {
            ...
            canvas2.drawRect(0.0f, edgeShadowTop, r0.mContentBounds.width() - (shadowOffset * 2.0f), (-r0.mCornerRadius) + r0.mShadowSize, r0.mEdgeShadowPaint);
        } else {
            shadowOffsetHorizontal = shadowScaleHorizontal3;
        }
        canvas2.restoreToCount(saved);
        ...
        if (drawVerticalEdges) {
            ...
            canvas2.drawRect(0.0f, edgeShadowTop, r0.mContentBounds.height() - (shadowOffset * 2.0f), -r0.mCornerRadius, r0.mEdgeShadowPaint);
        }
        canvas2.restoreToCount(saved);
        saved = canvas.save();
    ...
    private void buildShadowCorners() {
        ...
        if (shadowRadius > 0.0f) {
            ...
            i = 3;
            Shader radialGradient = new RadialGradient(0.0f, 0.0f, shadowRadius, new int[]{0, r0.mShadowStartColor, r0.mShadowMiddleColor, r0.mShadowEndColor}, new float[]{0.0f, startRatio, midRatio, 1.0f}, TileMode.CLAMP);
        ...
        paint2.setShader(new LinearGradient(0.0f, f, 0.0f, f2, iArr, new float[]{0.0f, SHADOW_HORIZ_SCALE, 1.0f}, TileMode.CLAMP));
