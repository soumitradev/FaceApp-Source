...
public class ChangeImageTransform extends Transition {
    ...
    private static final TypeEvaluator<Matrix> NULL_MATRIX_EVALUATOR = new C01371();
    ...
    static class C01371 implements TypeEvaluator<Matrix> {
        C01371() {
        }
    ...
    private static Matrix copyImageMatrix(ImageView view) {
        switch (C01393.$SwitchMap$android$widget$ImageView$ScaleType[view.getScaleType().ordinal()]) {
            case 1:
    ...
    private static Matrix centerCropMatrix(ImageView view) {
        ...
        int tx = Math.round((((float) imageViewWidth) - (((float) imageWidth) * maxScale)) / Ints.MAX_POWER_OF_TWO);
