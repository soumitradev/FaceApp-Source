...
public abstract class Transition implements Cloneable {
    ...
    private static final PathMotion STRAIGHT_PATH_MOTION = new C00551();
    ...
    class C00123 extends AnimatorListenerAdapter {
        C00123() {
        }
    ...
    static class C00551 extends PathMotion {
        C00551() {
        }
        ...
        if ((this.mTargetIds.size() > 0 || this.mTargets.size() > 0) && (this.mTargetNames == null || this.mTargetNames.isEmpty())) {
            ...
            if (!start && this.mNameOverrides != null) {
                ...
                for (int i2 = 0; i2 < i; i2++) {
                    overriddenViews.add(this.mStartValues.mNameValues.remove((String) this.mNameOverrides.keyAt(i2)));
                }
                for (int i3 = 0; i3 < i; i3++) {
                    view = (View) overriddenViews.get(i3);
                    if (view != null) {
    ...
    protected void animate(Animator animator) {
        ...
        animator.addListener(new C00123());
        animator.start();
    }
