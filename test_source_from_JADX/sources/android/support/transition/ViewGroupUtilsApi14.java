...
class ViewGroupUtilsApi14 implements ViewGroupUtilsImpl {
    ...
    class C01481 extends LayoutTransition {
        C01481() {
        }
    ...
    public void suppressLayout(@NonNull ViewGroup group, boolean suppress) {
        if (sEmptyLayoutTransition == null) {
            sEmptyLayoutTransition = new C01481();
        ...
        if (suppress) {
            ...
            if (layoutTransition != null) {
                ...
                if (layoutTransition != sEmptyLayoutTransition) {
                    group.setTag(C0147R.id.transition_layout_save, layoutTransition);
                }
            }
        ...
        LayoutTransition layoutTransition2 = (LayoutTransition) group.getTag(C0147R.id.transition_layout_save);
        if (layoutTransition2 != null) {
            group.setTag(C0147R.id.transition_layout_save, null);
