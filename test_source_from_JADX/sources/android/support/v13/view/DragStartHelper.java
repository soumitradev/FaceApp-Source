...
public class DragStartHelper {
    ...
    private final OnLongClickListener mLongClickListener = new C01491();
    private final OnTouchListener mTouchListener = new C01502();
    private final View mView;

    /* renamed from: android.support.v13.view.DragStartHelper$1 */
    class C01491 implements OnLongClickListener {
        C01491() {
        }
    ...
    class C01502 implements OnTouchListener {
        C01502() {
        }
