...
public class Fragment implements ComponentCallbacks, OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner {
    ...
    public static Fragment instantiate(Context context, String fname, @Nullable Bundle args) {
        ...
        try {
            ...
            throw new Fragment$InstantiationException(stringBuilder.toString(), e);
            ...
            stringBuilder.append(": make sure class name exists, is public, and has an");
            stringBuilder.append(" empty constructor that is public");
            throw new Fragment$InstantiationException(stringBuilder.toString(), e2);
            ...
            stringBuilder.append(": make sure class name exists, is public, and has an");
            stringBuilder.append(" empty constructor that is public");
            throw new Fragment$InstantiationException(stringBuilder.toString(), e3);
        } catch (NoSuchMethodException e4) {
            stringBuilder = new StringBuilder();
            stringBuilder.append("Unable to instantiate fragment ");
            stringBuilder.append(fname);
            stringBuilder.append(": could not find Fragment constructor");
            throw new Fragment$InstantiationException(stringBuilder.toString(), e4);
        } catch (InvocationTargetException e5) {
            stringBuilder = new StringBuilder();
            stringBuilder.append("Unable to instantiate fragment ");
            stringBuilder.append(fname);
            stringBuilder.append(": calling Fragment constructor caused an exception");
            throw new Fragment$InstantiationException(stringBuilder.toString(), e5);
        }
    }
    ...
    public void setEnterTransition(@Nullable Object transition) {
        Fragment$AnimationInfo.access$002(ensureAnimationInfo(), transition);
    }
    ...
    public void setReturnTransition(@Nullable Object transition) {
        Fragment$AnimationInfo.access$102(ensureAnimationInfo(), transition);
    }
    ...
    public Object getReturnTransition() {
        ...
        if (Fragment$AnimationInfo.access$100(this.mAnimationInfo) == USE_DEFAULT_TRANSITION) {
            ...
            enterTransition = Fragment$AnimationInfo.access$100(this.mAnimationInfo);
        }
        return enterTransition;
    }

    public void setExitTransition(@Nullable Object transition) {
        Fragment$AnimationInfo.access$202(ensureAnimationInfo(), transition);
    }
    ...
    public void setReenterTransition(@Nullable Object transition) {
        Fragment$AnimationInfo.access$302(ensureAnimationInfo(), transition);
    }
    ...
    public Object getReenterTransition() {
        ...
        if (Fragment$AnimationInfo.access$300(this.mAnimationInfo) == USE_DEFAULT_TRANSITION) {
            ...
            exitTransition = Fragment$AnimationInfo.access$300(this.mAnimationInfo);
        }
        return exitTransition;
    }

    public void setSharedElementEnterTransition(@Nullable Object transition) {
        Fragment$AnimationInfo.access$402(ensureAnimationInfo(), transition);
    }
    ...
    public void setSharedElementReturnTransition(@Nullable Object transition) {
        Fragment$AnimationInfo.access$502(ensureAnimationInfo(), transition);
    }
    ...
    public Object getSharedElementReturnTransition() {
        ...
        if (Fragment$AnimationInfo.access$500(this.mAnimationInfo) == USE_DEFAULT_TRANSITION) {
            ...
            sharedElementEnterTransition = Fragment$AnimationInfo.access$500(this.mAnimationInfo);
        }
        return sharedElementEnterTransition;
    }

    public void setAllowEnterTransitionOverlap(boolean allow) {
        Fragment$AnimationInfo.access$602(ensureAnimationInfo(), Boolean.valueOf(allow));
    }

    public boolean getAllowEnterTransitionOverlap() {
        if (this.mAnimationInfo != null) {
            if (Fragment$AnimationInfo.access$600(this.mAnimationInfo) != null) {
    ...
    public void setAllowReturnTransitionOverlap(boolean allow) {
        Fragment$AnimationInfo.access$702(ensureAnimationInfo(), Boolean.valueOf(allow));
    }

    public boolean getAllowReturnTransitionOverlap() {
        if (this.mAnimationInfo != null) {
            if (Fragment$AnimationInfo.access$700(this.mAnimationInfo) != null) {
