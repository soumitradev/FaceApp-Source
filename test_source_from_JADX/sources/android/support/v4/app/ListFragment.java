...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C01762();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C01751();
    ...
    class C01762 implements OnItemClickListener {
        C01762() {
        }
