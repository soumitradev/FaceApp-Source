...
public final class MediaBrowserCompat {
    ...
    public static class MediaItem implements Parcelable {
        public static final Creator<MediaItem> CREATOR = new C00161();
        ...
        static class C00161 implements Creator<MediaItem> {
            C00161() {
            }
    ...
    static class MediaBrowserImplApi21 implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl, ConnectionCallbackInternal {
        ...
        public void getItem(@NonNull String mediaId, @NonNull ItemCallback cb) {
            if (TextUtils.isEmpty(mediaId)) {
                ...
                this.mHandler.post(new MediaBrowserCompat$MediaBrowserImplApi21$1(this, cb, mediaId));
            } else if (this.mServiceBinderWrapper == null) {
                this.mHandler.post(new MediaBrowserCompat$MediaBrowserImplApi21$2(this, cb, mediaId));
            } else {
                try {
                    ...
                    Log.i(str, stringBuilder.toString());
                    this.mHandler.post(new MediaBrowserCompat$MediaBrowserImplApi21$3(this, cb, mediaId));
                }
            }
        }
        ...
        public void search(@NonNull String query, Bundle extras, @NonNull SearchCallback callback) {
            if (!isConnected()) {
                ...
                this.mHandler.post(new MediaBrowserCompat$MediaBrowserImplApi21$4(this, callback, query, extras));
            } else {
                try {
                    ...
                    this.mHandler.post(new MediaBrowserCompat$MediaBrowserImplApi21$5(this, callback, query, extras));
                }
            }
        }
        ...
        public void sendCustomAction(@NonNull String action, Bundle extras, @Nullable CustomActionCallback callback) {
            if (isConnected()) {
                if (this.mServiceBinderWrapper == null) {
                    ...
                    if (callback != null) {
                        this.mHandler.post(new MediaBrowserCompat$MediaBrowserImplApi21$6(this, callback, action, extras));
                    }
                }
                try {
                    ...
                    Log.i(str, stringBuilder.toString(), e);
                    if (callback != null) {
                        this.mHandler.post(new MediaBrowserCompat$MediaBrowserImplApi21$7(this, callback, action, extras));
                        return;
                    }
                    return;
                }
        ...
        public void getItem(@NonNull String mediaId, @NonNull ItemCallback cb) {
            if (TextUtils.isEmpty(mediaId)) {
                ...
                try {
                    ...
                    stringBuilder.append(mediaId);
                    Log.i(str, stringBuilder.toString());
                    this.mHandler.post(new MediaBrowserCompat$MediaBrowserImplBase$4(this, cb, mediaId));
                }
            } else {
                Log.i(MediaBrowserCompat.TAG, "Not connected, unable to retrieve the MediaItem.");
                this.mHandler.post(new MediaBrowserCompat$MediaBrowserImplBase$3(this, cb, mediaId));
            }
        }
        ...
        public void search(@NonNull String query, Bundle extras, @NonNull SearchCallback callback) {
            if (isConnected()) {
                try {
                    ...
                    stringBuilder.append(query);
                    Log.i(str, stringBuilder.toString(), e);
                    this.mHandler.post(new MediaBrowserCompat$MediaBrowserImplBase$5(this, callback, query, extras));
                    return;
                }
            }
            StringBuilder stringBuilder2 = new StringBuilder();
        ...
        public void sendCustomAction(@NonNull String action, Bundle extras, @Nullable CustomActionCallback callback) {
            if (isConnected()) {
                try {
                    ...
                    Log.i(str, stringBuilder.toString(), e);
                    if (callback != null) {
                        this.mHandler.post(new MediaBrowserCompat$MediaBrowserImplBase$6(this, callback, action, extras));
                        return;
                    }
                    return;
                }
