    ...
    private static class DirectionalityEstimator {
        ...
        byte dirTypeBackward() {
            ...
            if (this.isHtml) {
                ...
                } else if (this.lastChar == Constants.REMIX_URL_REPLACE_SEPARATOR) {
        ...
        private byte skipEntityForward() {
            while (this.charIndex < this.length) {
                ...
                this.lastChar = charAt;
                if (charAt == Constants.REMIX_URL_REPLACE_SEPARATOR) {
                    break;
                }
            }
            return (byte) 12;
        ...
        private byte skipEntityBackward() {
            ...
            while (this.charIndex > 0) {
                ...
                if (this.lastChar != Typography.amp) {
                    if (this.lastChar == Constants.REMIX_URL_REPLACE_SEPARATOR) {
                        break;
                    }
                }
                return (byte) 12;
            ...
            this.charIndex = initialCharIndex;
            this.lastChar = Constants.REMIX_URL_REPLACE_SEPARATOR;
            return (byte) 13;
        }
    }
