...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C00281();
    ...
    private static final Interpolator sInterpolator = new C00292();
    ...
    private final Runnable mEndScrollRunnable = new C00303();
    ...
    class C00624 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = new ViewPager$SavedState$1();
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C00624());
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        maxGutterSize = maxGutterSize2;
        r0.mChildWidthMeasureSpec = MeasureSpec.makeMeasureSpec(childHeightSize, Ints.MAX_POWER_OF_TWO);
        r0.mChildHeightMeasureSpec = MeasureSpec.makeMeasureSpec(childHeightSize2, Ints.MAX_POWER_OF_TWO);
        r0.mInLayout = true;
        populate();
        widthSize = 0;
        r0.mInLayout = false;
        ...
        while (widthSize < measuredWidth) {
            ...
            if (child2.getVisibility() != 8) {
                ...
                if (lp2 == null || !lp2.isDecor) {
                    child2.measure(MeasureSpec.makeMeasureSpec((int) (((float) childHeightSize) * lp2.widthFactor), Ints.MAX_POWER_OF_TWO), r0.mChildHeightMeasureSpec);
                }
            }
            widthSize++;
        }
