...
public final class ViewPropertyAnimatorCompat {
    ...
    public ViewPropertyAnimatorCompat withEndAction(Runnable runnable) {
        ...
        if (view != null) {
            if (VERSION.SDK_INT >= 16) {
                ...
                setListenerInternal(view2, new ViewPropertyAnimatorCompat$ViewPropertyAnimatorListenerApi14(this));
    ...
    private void setListenerInternal(View view, ViewPropertyAnimatorListener listener) {
        if (listener != null) {
            view.animate().setListener(new ViewPropertyAnimatorCompat$1(this, listener, view));
        } else {
    ...
    public ViewPropertyAnimatorCompat setUpdateListener(ViewPropertyAnimatorUpdateListener listener) {
        ...
        if (view != null && VERSION.SDK_INT >= 19) {
            ...
            if (listener != null) {
                wrapped = new ViewPropertyAnimatorCompat$2(this, listener, view2);
            }
