...
public class AccessibilityNodeInfoCompat {
    ...
    public AccessibilityNodeInfoCompat$CollectionInfoCompat getCollectionInfo() {
        if (VERSION.SDK_INT >= 19) {
            ...
            if (info != null) {
                return new AccessibilityNodeInfoCompat$CollectionInfoCompat(info);
            }
        }
        return null;
    }
    ...
    public void setCollectionInfo(Object collectionInfo) {
        if (VERSION.SDK_INT >= 19) {
            this.mInfo.setCollectionInfo((CollectionInfo) ((AccessibilityNodeInfoCompat$CollectionInfoCompat) collectionInfo).mInfo);
        }
    }

    public void setCollectionItemInfo(Object collectionItemInfo) {
        if (VERSION.SDK_INT >= 19) {
            this.mInfo.setCollectionItemInfo((CollectionItemInfo) ((AccessibilityNodeInfoCompat$CollectionItemInfoCompat) collectionItemInfo).mInfo);
        }
    }
    ...
    public AccessibilityNodeInfoCompat$CollectionItemInfoCompat getCollectionItemInfo() {
        if (VERSION.SDK_INT >= 19) {
            ...
            if (info != null) {
                return new AccessibilityNodeInfoCompat$CollectionItemInfoCompat(info);
            }
        }
        return null;
    }
    ...
    public AccessibilityNodeInfoCompat$RangeInfoCompat getRangeInfo() {
        if (VERSION.SDK_INT >= 19) {
            ...
            if (info != null) {
                return new AccessibilityNodeInfoCompat$RangeInfoCompat(info);
            }
        }
        return null;
    }
    ...
    public List<AccessibilityNodeInfoCompat$AccessibilityActionCompat> getActionList() {
        ...
        for (int i = 0; i < actionCount; i++) {
            result.add(new AccessibilityNodeInfoCompat$AccessibilityActionCompat(actions.get(i)));
        }
        return result;
    }
