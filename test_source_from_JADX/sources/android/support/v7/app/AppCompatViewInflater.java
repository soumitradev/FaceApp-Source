...
public class AppCompatViewInflater {
    ...
    private static class DeclaredOnClickListener implements OnClickListener {
        ...
        private void resolveMethod(@Nullable Context context, @NonNull String name) {
            ...
            if (id == -1) {
                ...
                idText.append(FormatHelper.QUOTE);
    ...
    private static Context themifyContext(Context context, AttributeSet attrs, boolean useAndroidTheme, boolean useAppTheme) {
        TypedArray a = context.obtainStyledAttributes(attrs, C0034R.styleable.View, 0, 0);
        int themeId = 0;
        if (useAndroidTheme) {
            themeId = a.getResourceId(C0034R.styleable.View_android_theme, 0);
        }
        if (useAppTheme && themeId == 0) {
            themeId = a.getResourceId(C0034R.styleable.View_theme, 0);
            if (themeId != 0) {
