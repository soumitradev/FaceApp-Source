...
class ToolbarActionBar extends ActionBar {
    ...
    private final Toolbar$OnMenuItemClickListener mMenuClicker = new C07032();
    private final Runnable mMenuInvalidator = new C02431();
    ...
    class C07032 implements Toolbar$OnMenuItemClickListener {
        C07032() {
        }
