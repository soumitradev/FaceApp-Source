...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C12101();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C12112();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C07043();

    /* renamed from: android.support.v7.app.WindowDecorActionBar$3 */
    class C07043 implements ViewPropertyAnimatorUpdateListener {
        C07043() {
        }
    ...
    class C12101 extends ViewPropertyAnimatorListenerAdapter {
        C12101() {
        }
    ...
    class C12112 extends ViewPropertyAnimatorListenerAdapter {
        C12112() {
        }
            ...
            if (this.mContainerView != null) {
                ...
                if (!abp.enableHomeButtonByDefault()) {
                    if (!homeAsUp) {
                        ...
                        a = this.mContext.obtainStyledAttributes(null, C0034R.styleable.ActionBar, C0034R.attr.actionBarStyle, 0);
                        if (a.getBoolean(C0034R.styleable.ActionBar_hideOnContentScroll, false)) {
                            setHideOnContentScrollEnabled(true);
                        }
                        elevation = a.getDimensionPixelSize(C0034R.styleable.ActionBar_elevation, 0);
                        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0034R.attr.actionBarWidgetTheme, outValue, true);
