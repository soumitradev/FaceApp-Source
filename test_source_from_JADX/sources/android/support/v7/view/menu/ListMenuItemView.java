...
public class ListMenuItemView extends LinearLayout implements MenuView$ItemView {
    ...
    public ListMenuItemView(Context context, AttributeSet attrs) {
        this(context, attrs, C0034R.attr.listMenuViewStyle);
    }

    public ListMenuItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs);
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(getContext(), attrs, C0034R.styleable.MenuView, defStyleAttr, 0);
        this.mBackground = a.getDrawable(C0034R.styleable.MenuView_android_itemBackground);
        this.mTextAppearance = a.getResourceId(C0034R.styleable.MenuView_android_itemTextAppearance, -1);
        this.mPreserveIconSpacing = a.getBoolean(C0034R.styleable.MenuView_preserveIconSpacing, false);
        this.mTextAppearanceContext = context;
        this.mSubMenuArrow = a.getDrawable(C0034R.styleable.MenuView_subMenuArrow);
        a.recycle();
    }
    ...
    private void insertIconView() {
        this.mIconView = (ImageView) getInflater().inflate(C0034R.layout.abc_list_menu_item_icon, this, false);
        addView(this.mIconView, 0);
    }

    private void insertRadioButton() {
        this.mRadioButton = (RadioButton) getInflater().inflate(C0034R.layout.abc_list_menu_item_radio, this, false);
        addView(this.mRadioButton);
    }

    private void insertCheckBox() {
        this.mCheckBox = (CheckBox) getInflater().inflate(C0034R.layout.abc_list_menu_item_checkbox, this, false);
