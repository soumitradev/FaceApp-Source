...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = new int[]{C0034R.attr.actionBarSize, 16842841};
    ...
    class C02671 extends AnimatorListenerAdapter {
        C02671() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C02671();
        this.mRemoveActionBarHideOffset = new C02682();
        this.mAddActionBarHideOffset = new C02693();
        init(context);
