...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    class C02733 extends AccessibilityDelegate {
        C02733() {
        }
    ...
    class C02745 extends DataSetObserver {
        C02745() {
        }
            ...
            switch (getItemViewType(position)) {
                case 0:
                    if (convertView == null || convertView.getId() != R$id.list_item) {
                        convertView = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0034R.layout.abc_activity_chooser_view_list_item, parent, false);
                    }
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray attributesArray = context.obtainStyledAttributes(attrs, C0034R.styleable.ActivityChooserView, defStyle, 0);
        this.mInitialActivityCount = attributesArray.getInt(C0034R.styleable.ActivityChooserView_initialActivityCount, 4);
        Drawable expandActivityOverflowButtonDrawable = attributesArray.getDrawable(C0034R.styleable.ActivityChooserView_expandActivityOverflowButtonDrawable);
        attributesArray.recycle();
        LayoutInflater.from(getContext()).inflate(C0034R.layout.abc_activity_chooser_view, this, true);
        ...
        expandButton.setAccessibilityDelegate(new C02733());
        ...
        this.mAdapter.registerDataSetObserver(new C02745());
