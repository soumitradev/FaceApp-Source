...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray ta = context.obtainStyledAttributes(attrs, C0034R.styleable.ButtonBarLayout);
        this.mAllowStacking = ta.getBoolean(C0034R.styleable.ButtonBarLayout_allowStacking, true);
        ta.recycle();
    }
