    ...
    public void onInitializeAccessibilityNodeInfoForItem(Recycler recycler, State state, View host, AccessibilityNodeInfoCompat info) {
        ...
        if (lp instanceof LayoutParams) {
            ...
            if (this.mOrientation == 0) {
                ...
                info.setCollectionItemInfo(AccessibilityNodeInfoCompat$CollectionItemInfoCompat.obtain(spanIndex, spanSize, spanGroupIndex, 1, z, false));
            } else {
                int spanIndex2 = glp.getSpanIndex();
                int spanSize2 = glp.getSpanSize();
                boolean z2 = this.mSpanCount > 1 && glp.getSpanSize() == this.mSpanCount;
                info.setCollectionItemInfo(AccessibilityNodeInfoCompat$CollectionItemInfoCompat.obtain(spanGroupIndex, 1, spanIndex2, spanSize2, z2, false));
            }
            return;
        }
        ...
        while (pos < count2) {
            ...
            if (r6.mOrientationHelper.getDecoratedMeasurement(view3) != count) {
                ...
                if (r6.mOrientation == 1) {
                    i = remainingSpan2;
                    wSpec = getChildMeasureSpec(size, Ints.MAX_POWER_OF_TWO, horizontalInsets, lp.width, false);
                    ...
                    otherDirSpecMode = getChildMeasureSpec(size, Ints.MAX_POWER_OF_TWO, maxSizeInOther2, lp.height, null);
                }
