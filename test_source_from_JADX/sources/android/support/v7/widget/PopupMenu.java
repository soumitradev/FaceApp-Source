...
public class PopupMenu {
    ...
    class C02802 implements android.widget.PopupWindow.OnDismissListener {
        C02802() {
        }
    ...
    class C07241 implements Callback {
        C07241() {
        }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity) {
        this(context, anchor, gravity, C0034R.attr.popupMenuStyle, 0);
    }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes) {
        ...
        this.mMenu.setCallback(new C07241());
        ...
        this.mPopup.setOnDismissListener(new C02802());
    }
