...
import android.support.v7.recyclerview.C0035R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    static final Interpolator sQuinticInterpolator = new C00403();
    ...
    static class C00403 implements Interpolator {
        C00403() {
        }
    ...
    public static abstract class LayoutManager {
        ...
        public static int getChildMeasureSpec(int parentSize, int parentMode, int padding, int childDimension, boolean canScroll) {
            ...
            if (canScroll) {
                if (childDimension >= 0) {
                    ...
                    if (parentMode != Integer.MIN_VALUE) {
                        if (parentMode == 0) {
                            resultSize = 0;
                            resultMode = 0;
                        } else if (parentMode != Ints.MAX_POWER_OF_TWO) {
                        }
                    }
                    resultSize = size;
                ...
                resultSize = size;
                if (parentMode != Integer.MIN_VALUE) {
                    if (parentMode != Ints.MAX_POWER_OF_TWO) {
                        resultMode = 0;
                    }
                }
                resultMode = Integer.MIN_VALUE;
        ...
        public static RecyclerView$LayoutManager$Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0035R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0035R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0035R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0035R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0035R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    public final class Recycler {
        ...
        ViewHolder tryGetViewHolderForPositionByDeadline(int position, boolean dryRun, long deadlineNs) {
            ...
            stringBuilder3.append(Constants.OPENING_BRACE);
            stringBuilder3.append(i);
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mUpdateChildViewsRunnable = new C00381();
        ...
        r6.mItemAnimatorRunner = new C00392();
        r6.mViewInfoProcessCallback = new C00644();
        ...
        if (attributeSet != null) {
            TypedArray a2 = context2.obtainStyledAttributes(attributeSet, C0035R.styleable.RecyclerView, i, 0);
            String layoutManagerName = a2.getString(C0035R.styleable.RecyclerView_layoutManager);
            int descendantFocusability = a2.getInt(C0035R.styleable.RecyclerView_android_descendantFocusability, -1);
            if (descendantFocusability == -1) {
                setDescendantFocusability(262144);
            }
            r6.mEnableFastScroller = a2.getBoolean(C0035R.styleable.RecyclerView_fastScrollEnabled, false);
            if (r6.mEnableFastScroller) {
                initFastScroller((StateListDrawable) a2.getDrawable(C0035R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), a2.getDrawable(C0035R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) a2.getDrawable(C0035R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), a2.getDrawable(C0035R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
            a2.recycle();
    ...
    void initFastScroller(StateListDrawable verticalThumbDrawable, Drawable verticalTrackDrawable, StateListDrawable horizontalThumbDrawable, Drawable horizontalTrackDrawable) {
        if (!(verticalThumbDrawable == null || verticalTrackDrawable == null || horizontalThumbDrawable == null)) {
            if (horizontalTrackDrawable != null) {
                ...
                FastScroller fastScroller = new FastScroller(this, verticalThumbDrawable, verticalTrackDrawable, horizontalThumbDrawable, horizontalTrackDrawable, resources.getDimensionPixelSize(C0035R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0035R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0035R.dimen.fastscroll_margin));
                return;
            }
        }
        StringBuilder stringBuilder = new StringBuilder();
