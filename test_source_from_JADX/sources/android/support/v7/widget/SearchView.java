...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attrs) {
            this(context, attrs, C0034R.attr.autoCompleteTextViewStyle);
        }
        ...
        private int getSearchViewTextMinWidthDp() {
            ...
            if (widthDp >= 960 && heightDp >= ScreenValues.CAST_SCREEN_HEIGHT && config.orientation == 2) {
                return 256;
            }
            if (widthDp < SettingsJsonConstants.ANALYTICS_FLUSH_INTERVAL_SECS_DEFAULT) {
    ...
    public SearchView(Context context, AttributeSet attrs) {
        this(context, attrs, C0034R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0034R.styleable.SearchView, defStyleAttr, 0);
        LayoutInflater.from(context).inflate(a.getResourceId(C0034R.styleable.SearchView_layout, C0034R.layout.abc_search_view), this, true);
        ...
        ViewCompat.setBackground(this.mSearchPlate, a.getDrawable(C0034R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, a.getDrawable(C0034R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(C0034R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(C0034R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(C0034R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(C0034R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(C0034R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C0034R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(this.mSearchButton, getResources().getString(R$string.abc_searchview_description_search));
        this.mSuggestionRowLayout = a.getResourceId(C0034R.styleable.SearchView_suggestionRowLayout, C0034R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(C0034R.styleable.SearchView_commitIcon, 0);
        ...
        setIconifiedByDefault(a.getBoolean(C0034R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a.getDimensionPixelSize(C0034R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a.getText(C0034R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a.getText(C0034R.styleable.SearchView_queryHint);
        int imeOptions = a.getInt(C0034R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(C0034R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        setFocusable(a.getBoolean(C0034R.styleable.SearchView_android_focusable, true));
        a.recycle();
    ...
    void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0034R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0034R.dimen.abc_dropdownitem_text_padding_left) : 0;
