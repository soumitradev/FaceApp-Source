...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean style, int defaultNavigationContentDescription, int defaultNavigationIcon) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(toolbar.getContext(), null, C0034R.styleable.ActionBar, C0034R.attr.actionBarStyle, 0);
        r0.mDefaultNavigationIcon = a.getDrawable(C0034R.styleable.ActionBar_homeAsUpIndicator);
        if (style) {
            CharSequence title = a.getText(C0034R.styleable.ActionBar_title);
            if (!TextUtils.isEmpty(title)) {
                setTitle(title);
            }
            CharSequence subtitle = a.getText(C0034R.styleable.ActionBar_subtitle);
            if (!TextUtils.isEmpty(subtitle)) {
                setSubtitle(subtitle);
            }
            Drawable logo = a.getDrawable(C0034R.styleable.ActionBar_logo);
            if (logo != null) {
                setLogo(logo);
            }
            Drawable icon = a.getDrawable(C0034R.styleable.ActionBar_icon);
            if (icon != null) {
                setIcon(icon);
            }
            ...
            setDisplayOptions(a.getInt(C0034R.styleable.ActionBar_displayOptions, 0));
            int customNavId = a.getResourceId(C0034R.styleable.ActionBar_customNavigationLayout, 0);
            if (customNavId != 0) {
            ...
            int contentInsetStart = a.getDimensionPixelOffset(C0034R.styleable.ActionBar_contentInsetStart, -1);
            int contentInsetEnd = a.getDimensionPixelOffset(C0034R.styleable.ActionBar_contentInsetEnd, -1);
            if (contentInsetStart >= 0 || contentInsetEnd >= 0) {
                r0.mToolbar.setContentInsetsRelative(Math.max(contentInsetStart, 0), Math.max(contentInsetEnd, 0));
            }
            int titleTextStyle = a.getResourceId(C0034R.styleable.ActionBar_titleTextStyle, 0);
            if (titleTextStyle != 0) {
                r0.mToolbar.setTitleTextAppearance(r0.mToolbar.getContext(), titleTextStyle);
            }
            int subtitleTextStyle = a.getResourceId(C0034R.styleable.ActionBar_subtitleTextStyle, 0);
            if (subtitleTextStyle != 0) {
                r0.mToolbar.setSubtitleTextAppearance(r0.mToolbar.getContext(), subtitleTextStyle);
            }
            int popupTheme = a.getResourceId(C0034R.styleable.ActionBar_popupTheme, 0);
            if (popupTheme != 0) {
        ...
        r0.mToolbar.setNavigationOnClickListener(new C02971());
    }
