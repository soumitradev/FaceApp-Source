...
class TooltipPopup {
    ...
    TooltipPopup(Context context) {
        ...
        this.mContentView = LayoutInflater.from(this.mContext).inflate(C0034R.layout.abc_tooltip, null);
        ...
        this.mLayoutParams.windowAnimations = C0034R.style.Animation_AppCompat_Tooltip;
    ...
    private void computePosition(View anchorView, int anchorX, int anchorY, boolean fromTouch, LayoutParams outParams) {
        ...
        int tooltipPreciseAnchorThreshold = this.mContext.getResources().getDimensionPixelOffset(C0034R.dimen.tooltip_precise_anchor_threshold);
        ...
        if (anchorView.getHeight() >= tooltipPreciseAnchorThreshold) {
            offsetAbove = r0.mContext.getResources().getDimensionPixelOffset(C0034R.dimen.tooltip_precise_anchor_extra_offset);
        ...
        int tooltipOffset = r0.mContext.getResources().getDimensionPixelOffset(fromTouch ? C0034R.dimen.tooltip_y_offset_touch : C0034R.dimen.tooltip_y_offset_non_touch);
