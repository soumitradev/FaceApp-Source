...
public abstract class MeshSpawnShapeValue extends SpawnShapeValue {
    ...
    public void save(AssetManager manager, ResourceData data) {
        if (this.model != null) {
            ...
            saveData.save(FirebaseAnalytics$Param.INDEX, Integer.valueOf(this.model.meshes.indexOf(this.mesh, true)));
        }
    }
    ...
    public void load(AssetManager manager, ResourceData data) {
        ...
        if (descriptor != null) {
            ...
            setMesh((Mesh) model.meshes.get(((Integer) saveData.load(FirebaseAnalytics$Param.INDEX)).intValue()), model);
        }
    }
}
