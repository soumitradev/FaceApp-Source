...
public class ModelBuilder {
    ...
    public Model createArrow(Vector3 from, Vector3 to, Material material, long attributes) {
        ...
        Vector3 vector32 = to;
        return createArrow(vector3.f120x, vector3.f121y, vector3.f122z, vector32.f120x, vector32.f121y, vector32.f122z, 0.1f, 0.1f, 5, 4, material, attributes);
    }
    ...
    public Model createLineGrid(int xDivisions, int zDivisions, float xSize, float zSize, Material material, long attributes) {
        ...
        while (true) {
            ...
            if (i4 <= i2) {
                j = i4;
                float x12 = z2;
                partBuilder.line(z2, 0.0f, x1, x22, 0.0f, x2);
                x1 += zSize;
                x2 += zSize;
                j++;
                z2 = x12;
