...
public class ShaderProgram implements Disposable {
    ...
    private void compileShaders(String vertexShader, String fragmentShader) {
        ...
        if (this.vertexShaderHandle != -1) {
            if (this.fragmentShaderHandle != -1) {
    ...
    public void setUniformf(String name, Vector2 values) {
        setUniformf(name, values.f16x, values.f17y);
    }

    public void setUniformf(int location, Vector2 values) {
        setUniformf(location, values.f16x, values.f17y);
    }

    public void setUniformf(String name, Vector3 values) {
        setUniformf(name, values.f120x, values.f121y, values.f122z);
    }

    public void setUniformf(int location, Vector3 values) {
        setUniformf(location, values.f120x, values.f121y, values.f122z);
    }

    public void setUniformf(String name, Color values) {
        setUniformf(name, values.f4r, values.f3g, values.f2b, values.f1a);
    }

    public void setUniformf(int location, Color values) {
        setUniformf(location, values.f4r, values.f3g, values.f2b, values.f1a);
    }
