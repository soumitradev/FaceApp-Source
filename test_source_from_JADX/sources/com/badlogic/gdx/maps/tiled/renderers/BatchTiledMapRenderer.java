...
public abstract class BatchTiledMapRenderer implements TiledMapRenderer, Disposable {
    ...
    public void renderImageLayer(TiledMapImageLayer layer) {
        ...
        float color = Color.toFloatBits(batchColor.f4r, batchColor.f3g, batchColor.f2b, batchColor.f1a * layer.getOpacity());
        ...
        if (region != null) {
            ...
            r0.imageBounds.set(x1, y1, x2 - x1, y2 - y1);
            if (!r0.viewBounds.contains(r0.imageBounds)) {
                if (!r0.viewBounds.overlaps(r0.imageBounds)) {
            ...
            vertices[18] = u2;
            vertices[19] = v1;
            r0.batch.draw(region.getTexture(), vertices, 0.0f, 20);
        }
    }
