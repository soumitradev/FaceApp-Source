...
public final class Affine2 implements Serializable {
    ...
    public Affine2 setToTranslation(Vector2 trn) {
        return setToTranslation(trn.f16x, trn.f17y);
    }
    ...
    public Affine2 setToScaling(Vector2 scale) {
        return setToScaling(scale.f16x, scale.f17y);
    }
    ...
    public Affine2 setToShearing(Vector2 shear) {
        return setToShearing(shear.f16x, shear.f17y);
    }
    ...
    public Affine2 setToTrnRotScl(Vector2 trn, float degrees, Vector2 scale) {
        return setToTrnRotScl(trn.f16x, trn.f17y, degrees, scale.f16x, scale.f17y);
    }
    ...
    public Affine2 setToTrnRotRadScl(Vector2 trn, float radians, Vector2 scale) {
        return setToTrnRotRadScl(trn.f16x, trn.f17y, radians, scale.f16x, scale.f17y);
    }
    ...
    public Affine2 setToTrnScl(Vector2 trn, Vector2 scale) {
        return setToTrnScl(trn.f16x, trn.f17y, scale.f16x, scale.f17y);
    }
    ...
    public Affine2 translate(Vector2 trn) {
        return translate(trn.f16x, trn.f17y);
    }
    ...
    public Affine2 preTranslate(Vector2 trn) {
        return preTranslate(trn.f16x, trn.f17y);
    }
    ...
    public Affine2 scale(Vector2 scale) {
        return scale(scale.f16x, scale.f17y);
    }
    ...
    public Affine2 preScale(Vector2 scale) {
        return preScale(scale.f16x, scale.f17y);
    }
    ...
    public Affine2 shear(float shearX, float shearY) {
        ...
        this.m01 = tmp1;
        float tmp12 = this.m11 + (this.m10 * shearX);
    ...
    public Affine2 shear(Vector2 shear) {
        return shear(shear.f16x, shear.f17y);
    }
    ...
    public Affine2 preShear(Vector2 shear) {
        return preShear(shear.f16x, shear.f17y);
    }
    ...
    public Vector2 getTranslation(Vector2 position) {
        position.f16x = this.m02;
        position.f17y = this.m12;
        return position;
    }
    ...
    public void applyTo(Vector2 point) {
        float x = point.f16x;
        float y = point.f17y;
        point.f16x = ((this.m00 * x) + (this.m01 * y)) + this.m02;
        point.f17y = ((this.m10 * x) + (this.m11 * y)) + this.m12;
    }
