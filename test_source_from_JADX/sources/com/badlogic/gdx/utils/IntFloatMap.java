...
public class IntFloatMap implements Iterable<Entry> {
    ...
    public void put(int key, float value) {
        ...
        float f = value;
        if (i == 0) {
            intFloatMap.zeroValue = f;
            if (!intFloatMap.hasZeroValue) {
                intFloatMap.hasZeroValue = true;
                intFloatMap.size++;
            }
            return;
        }
        int[] keyTable = intFloatMap.keyTable;
        int index1 = i & intFloatMap.mask;
        int key1 = keyTable[index1];
        if (i == key1) {
            intFloatMap.valueTable[index1] = f;
            return;
        }
        int index2 = hash2(key);
        int key2 = keyTable[index2];
        if (i == key2) {
            intFloatMap.valueTable[index2] = f;
            return;
        }
        int index3 = hash3(key);
        int key3 = keyTable[index3];
        if (i == key3) {
            intFloatMap.valueTable[index3] = f;
            return;
        }
        int i2 = intFloatMap.capacity;
        int n = intFloatMap.stashSize + i2;
        while (i2 < n) {
            if (i == keyTable[i2]) {
                intFloatMap.valueTable[i2] = f;
                return;
            }
            i2++;
        }
        if (key1 == 0) {
            ...
            intFloatMap.valueTable[index1] = f;
            i2 = intFloatMap.size;
            intFloatMap.size = i2 + 1;
            if (i2 >= intFloatMap.threshold) {
                resize(intFloatMap.capacity << 1);
            }
        } else if (key2 == 0) {
            keyTable[index2] = i;
            intFloatMap.valueTable[index2] = f;
            ...
            push(i, f, index1, key1, index2, key2, index3, key3);
        }
    }
    ...
    private void putResize(int key, float value) {
        ...
        int index1 = key & intFloatMap.mask;
        int key1 = intFloatMap.keyTable[index1];
        if (key1 == 0) {
            int i;
            intFloatMap.keyTable[index1] = key;
            intFloatMap.valueTable[index1] = f;
            i = intFloatMap.size;
            intFloatMap.size = i + 1;
            if (i >= intFloatMap.threshold) {
                resize(intFloatMap.capacity << 1);
            }
            return;
        }
        int index2 = hash2(key);
        int key2 = intFloatMap.keyTable[index2];
        if (key2 == 0) {
            intFloatMap.keyTable[index2] = key;
            intFloatMap.valueTable[index2] = f;
            i = intFloatMap.size;
            intFloatMap.size = i + 1;
            if (i >= intFloatMap.threshold) {
        ...
        int index3 = hash3(key);
        int key3 = intFloatMap.keyTable[index3];
        if (key3 == 0) {
            intFloatMap.keyTable[index3] = key;
            intFloatMap.valueTable[index3] = f;
            i = intFloatMap.size;
            intFloatMap.size = i + 1;
            if (i >= intFloatMap.threshold) {
        ...
        push(key, f, index1, key1, index2, key2, index3, key3);
    }
