...
public abstract class Viewport {
    ...
    public Vector2 toScreenCoordinates(Vector2 worldCoords, Matrix4 transformMatrix) {
        this.tmp.set(worldCoords.f16x, worldCoords.f17y, 0.0f);
        this.tmp.mul(transformMatrix);
        this.camera.project(this.tmp);
        this.tmp.f121y = ((float) Gdx.graphics.getHeight()) - this.tmp.f121y;
        worldCoords.f16x = this.tmp.f120x;
        worldCoords.f17y = this.tmp.f121y;
        return worldCoords;
    }
