...
public abstract class FacebookButtonBase extends Button {
    ...
    protected FacebookButtonBase(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes, String analyticsButtonCreatedEventName, String analyticsButtonTappedEventName) {
        ...
        configureButton(context, attrs, defStyleAttr, defStyleRes == 0 ? C0410R.style.com_facebook_button : defStyleRes);
        ...
        if (!isInEditMode()) {
            ...
            try {
                if (a.hasValue(0)) {
                    ...
                    setBackgroundColor(ContextCompat.getColor(context, C0410R.color.com_facebook_blue));
                }
                a.recycle();
            } catch (Throwable th) {
                a.recycle();
    ...
    private void setupOnClickListener() {
        super.setOnClickListener(new C03991());
    }
}
