...
public class TestUserManager {
    ...
    private AccessToken getAccessTokenForUser(List<String> permissions, Mode mode, String uniqueUserTag) {
        ...
        JSONObject testAccount2 = testAccount;
        return new AccessToken(testAccount2.optString("access_token"), this.testApplicationId, testAccount2.optString(ShareConstants.WEB_DIALOG_PARAM_ID), permissions, null, AccessTokenSource.TEST_USER, null, null);
    }
