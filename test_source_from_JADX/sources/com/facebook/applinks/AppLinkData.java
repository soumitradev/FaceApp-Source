...
public class AppLinkData {
    ...
    private static void fetchDeferredAppLinkFromServer(Context context, String applicationId, CompletionHandler completionHandler) {
        ...
        try {
            ...
            throw new FacebookException("An error occurred while preparing deferred app link", e4);
        }
    }
        ...
        try {
            ...
            if (appLinkArgsJson.getJSONObject("bridge_args").getString("method").equals("applink") && version.equals("2")) {
                ...
                if (appLinkData.arguments.has(METHOD_ARGS_REF_KEY)) {
                    ...
                    refererData = appLinkData.arguments.getJSONObject(ARGUMENTS_REFERER_DATA_KEY);
                ...
                if (appLinkData.arguments.has(ARGUMENTS_EXTRAS_KEY)) {
                    refererData = appLinkData.arguments.getJSONObject(ARGUMENTS_EXTRAS_KEY);
                    if (refererData.has("deeplink_context")) {
                        JSONObject deeplink_context = refererData.getJSONObject("deeplink_context");
