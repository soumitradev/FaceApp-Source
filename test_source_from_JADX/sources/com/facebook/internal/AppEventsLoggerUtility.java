...
public class AppEventsLoggerUtility {
    private static final Map<GraphAPIActivityType, String> API_ACTIVITY_TYPE_TO_STRING = new C04291();

    /* renamed from: com.facebook.internal.AppEventsLoggerUtility$1 */
    static class C04291 extends HashMap<GraphAPIActivityType, String> {
        C04291() {
