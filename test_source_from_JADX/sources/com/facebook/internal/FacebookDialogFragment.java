...
public class FacebookDialogFragment extends DialogFragment {
    ...
    class C08321 implements OnCompleteListener {
        C08321() {
        }
    ...
    class C08332 implements OnCompleteListener {
        C08332() {
        }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (this.dialog == null) {
            ...
            if (params.getBoolean(NativeProtocol.WEB_DIALOG_IS_FALLBACK, false)) {
                ...
                WebDialog webDialog2 = new FacebookWebFallbackDialog(activity, url, String.format("fb%s://bridge/", new Object[]{FacebookSdk.getApplicationId()}));
                webDialog2.setOnCompleteListener(new C08332());
                ...
                webDialog = new Builder(activity, actionName, webParams).setOnCompleteListener(new C08321()).build();
            }
