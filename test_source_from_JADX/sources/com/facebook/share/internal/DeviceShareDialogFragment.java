...
public class DeviceShareDialogFragment extends DialogFragment {
    ...
    private static class RequestState implements Parcelable {
        public static final Creator<RequestState> CREATOR = new C04761();
        private long expiresIn;
        private String userCode;

        /* renamed from: com.facebook.share.internal.DeviceShareDialogFragment$RequestState$1 */
        static class C04761 implements Creator<RequestState> {
            C04761() {
            }
    ...
    class C08562 implements Callback {
        C08562() {
        }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        ((Button) view.findViewById(C0410R.id.cancel_button)).setOnClickListener(new C04741());
        ...
        ((TextView) view.findViewById(C0410R.id.com_facebook_device_dialog_title)).setText(getString(C0410R.string.com_facebook_share_button_text));
    ...
    private void startShare() {
        ...
        new GraphRequest(null, DEVICE_SHARE_ENDPOINT, parameters, HttpMethod.POST, new C08562()).executeAsync();
    }
    ...
    private void setCurrentRequestState(RequestState currentRequestState) {
        ...
        this.codeExpiredFuture = getBackgroundExecutor().schedule(new C04753(), currentRequestState.getExpiresIn(), TimeUnit.SECONDS);
    }
}
