...
public class ShareContentValidation {
    ...
    private static void validateOpenGraphContent(ShareOpenGraphContent openGraphContent, Validator validator) {
        ...
        if (Utility.isNullOrEmpty(previewPropertyName)) {
            ...
            stringBuilder.append("\" was not found on the action. ");
            stringBuilder.append("The name of the preview property must match the name of an ");
            stringBuilder.append("action property.");
