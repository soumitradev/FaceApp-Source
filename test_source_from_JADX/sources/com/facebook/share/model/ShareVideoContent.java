...
public final class ShareVideoContent extends ShareContent<ShareVideoContent, Builder> implements ShareModel {
    public static final Creator<ShareVideoContent> CREATOR = new C05001();
    ...
    static class C05001 implements Creator<ShareVideoContent> {
        C05001() {
        }
    ...
    ShareVideoContent(Parcel in) {
        ...
        if (previewPhotoBuilder.getImageUrl() == null) {
            if (previewPhotoBuilder.getBitmap() == null) {
