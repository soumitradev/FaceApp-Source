...
public final class zzct<R extends Result> extends PendingResult<R> {
    ...
    public zzct(Status status) {
        zzbq.zza(status, "Status must not be null");
        zzbq.zzb(status.isSuccess() ^ 1, "Status must not be success");
        this.zza = status;
    }
    ...
    @Hide
    public final void zza(@NonNull PendingResult$zza pendingResult$zza) {
        throw new UnsupportedOperationException("Operation not supported on PendingResults generated by ResultTransform.createFailedResult()");
    }
