...
public final class zzby extends Button {
    ...
    public final void zza(Resources resources, int i, int i2) {
        ...
        setMinHeight(i3);
        setMinWidth(i3);
        i3 = zza(i2, R$drawable.common_google_signin_btn_icon_dark, R$drawable.common_google_signin_btn_icon_light, R$drawable.common_google_signin_btn_icon_light);
        int zza = zza(i2, R$drawable.common_google_signin_btn_text_dark, R$drawable.common_google_signin_btn_text_light, R$drawable.common_google_signin_btn_text_light);
        switch (i) {
            case 0:
            case 1:
                i3 = zza;
        ...
        setTextColor((ColorStateList) zzbq.zza(resources.getColorStateList(zza(i2, R$color.common_google_signin_btn_text_dark, R$color.common_google_signin_btn_text_light, R$color.common_google_signin_btn_text_light))));
        switch (i) {
            case 0:
