...
public final class zze {
    ...
    public static void zza(Context context, String str, int i, String str2, String str3, String str4, int i2, List<String> list, long j) {
        ...
        if (7 == i3 || 8 == i3 || 10 == i3 || 11 == i3) {
            ...
            int zza = zzk.zza(context);
            str5 = context.getPackageName();
            WakeLockEvent wakeLockEvent = r1;
            WakeLockEvent wakeLockEvent2 = new WakeLockEvent(currentTimeMillis, i3, str2, i2, list3, str, elapsedRealtime, zza, str3, "com.google.android.gms".equals(str5) ? null : str5, zzk.zzb(context), j, str4);
            try {
