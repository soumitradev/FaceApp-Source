...
public class FinalizableReferenceQueue implements Closeable {
    ...
    private static final Method startFinalizer = getStartFinalizer(loadFinalizer(new FinalizableReferenceQueue$FinalizerLoader[]{new SystemLoader(), new DecoupledLoader(), new DirectLoader()}));
