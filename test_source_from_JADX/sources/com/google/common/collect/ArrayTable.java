...
public final class ArrayTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    public Map<R, V> column(C columnKey) {
        Preconditions.checkNotNull(columnKey);
        Integer columnIndex = (Integer) this.columnKeyToIndex.get(columnKey);
        return columnIndex == null ? ImmutableMap.of() : new ArrayTable$Column(this, columnIndex.intValue());
    }
    ...
    public Map<C, Map<R, V>> columnMap() {
        ArrayTable$ColumnMap map = this.columnMap;
        if (map != null) {
            return map;
        }
        Map<C, Map<R, V>> arrayTable$ColumnMap = new ArrayTable$ColumnMap(this, null);
    ...
    public Map<C, V> row(R rowKey) {
        Preconditions.checkNotNull(rowKey);
        Integer rowIndex = (Integer) this.rowKeyToIndex.get(rowKey);
        return rowIndex == null ? ImmutableMap.of() : new ArrayTable$Row(this, rowIndex.intValue());
    }
    ...
    public Map<R, Map<C, V>> rowMap() {
        ...
        Map<R, Map<C, V>> arrayTable$RowMap = new ArrayTable$RowMap(this, null);
