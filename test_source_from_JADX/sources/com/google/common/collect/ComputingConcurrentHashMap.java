...
class ComputingConcurrentHashMap<K, V> extends MapMakerInternalMap<K, V> {
    ...
    private static final class ComputationExceptionReference<K, V> implements ValueReference<K, V> {
        ...
        public V waitForValue() throws ExecutionException {
            throw new ExecutionException(this.f130t);
        }
    ...
    static final class ComputingSegment<K, V> extends Segment<K, V> {
        ...
        V getOrCompute(K r12, int r13, com.google.common.base.Function<? super K, ? extends V> r14) throws java.util.concurrent.ExecutionException {
            ...
            r11 = this;
        L_0x0000:
            r0 = r11.getEntry(r12, r13);	 Catch:{ all -> 0x00f2 }
            if (r0 == 0) goto L_0x0014;
        L_0x0006:
            r1 = r11.getLiveValue(r0);	 Catch:{ all -> 0x00f2 }
        ...
        L_0x0016:
            r1 = r0.getValueReference();	 Catch:{ all -> 0x00f2 }
            r1 = r1.isComputingReference();	 Catch:{ all -> 0x00f2 }
        ...
        L_0x0020:
            ...
            r3 = r11.count;	 Catch:{ all -> 0x00ea }
            r3 = r3 + -1;
            r4 = r11.table;	 Catch:{ all -> 0x00ea }
            r5 = r4.length();	 Catch:{ all -> 0x00ea }
            r5 = r5 + -1;
            r5 = r5 & r13;
            r6 = r4.get(r5);	 Catch:{ all -> 0x00ea }
            r6 = (com.google.common.collect.MapMakerInternalMap.ReferenceEntry) r6;	 Catch:{ all -> 0x00ea }
            r0 = r6;
        L_0x003c:
            if (r0 == 0) goto L_0x00a6;
        L_0x003e:
            r7 = r0.getKey();	 Catch:{ all -> 0x00ea }
            r8 = r0.getHash();	 Catch:{ all -> 0x00ea }
            if (r8 != r13) goto L_0x00a0;
        L_0x0048:
            if (r7 == 0) goto L_0x00a0;
        L_0x004a:
            r8 = r11.map;	 Catch:{ all -> 0x00ea }
            r8 = r8.keyEquivalence;	 Catch:{ all -> 0x00ea }
            r8 = r8.equivalent(r12, r7);	 Catch:{ all -> 0x00ea }
            if (r8 == 0) goto L_0x00a0;
        L_0x0054:
            r8 = r0.getValueReference();	 Catch:{ all -> 0x00ea }
            r9 = r8.isComputingReference();	 Catch:{ all -> 0x00ea }
            if (r9 == 0) goto L_0x0060;
        L_0x005e:
            r1 = 0;
            goto L_0x00a6;
        L_0x0060:
            r9 = r0.getValueReference();	 Catch:{ all -> 0x00ea }
            r9 = r9.get();	 Catch:{ all -> 0x00ea }
            if (r9 != 0) goto L_0x0070;
        L_0x006a:
            r10 = com.google.common.collect.MapMaker$RemovalCause.COLLECTED;	 Catch:{ all -> 0x00ea }
            r11.enqueueNotification(r7, r13, r9, r10);	 Catch:{ all -> 0x00ea }
            goto L_0x0085;
        L_0x0070:
            r10 = r11.map;	 Catch:{ all -> 0x00ea }
            r10 = r10.expires();	 Catch:{ all -> 0x00ea }
            if (r10 == 0) goto L_0x0092;
        L_0x0078:
            r10 = r11.map;	 Catch:{ all -> 0x00ea }
            r10 = r10.isExpired(r0);	 Catch:{ all -> 0x00ea }
            if (r10 == 0) goto L_0x0092;
        L_0x0080:
            r10 = com.google.common.collect.MapMaker$RemovalCause.EXPIRED;	 Catch:{ all -> 0x00ea }
            r11.enqueueNotification(r7, r13, r9, r10);	 Catch:{ all -> 0x00ea }
        L_0x0085:
            r10 = r11.evictionQueue;	 Catch:{ all -> 0x00ea }
            r10.remove(r0);	 Catch:{ all -> 0x00ea }
            r10 = r11.expirationQueue;	 Catch:{ all -> 0x00ea }
            r10.remove(r0);	 Catch:{ all -> 0x00ea }
        ...
        L_0x0092:
            ...
            return r9;
        L_0x00a0:
            r7 = r0.getNext();	 Catch:{ all -> 0x00ea }
            r0 = r7;
            goto L_0x003c;
        L_0x00a6:
            if (r1 == 0) goto L_0x00bf;
        L_0x00a8:
            r7 = new com.google.common.collect.ComputingConcurrentHashMap$ComputingValueReference;	 Catch:{ all -> 0x00ea }
            r7.<init>(r14);	 Catch:{ all -> 0x00ea }
            r2 = r7;
            if (r0 != 0) goto L_0x00bc;
        L_0x00b0:
            r7 = r11.newEntry(r12, r13, r6);	 Catch:{ all -> 0x00ea }
            r0 = r7;
        ...
        L_0x00bf:
            ...
            if (r1 == 0) goto L_0x00d0;
        L_0x00c8:
            r3 = r11.compute(r12, r13, r0, r2);	 Catch:{ all -> 0x00f2 }
            r11.postReadCleanup();
            return r3;
        L_0x00d0:
            r1 = java.lang.Thread.holdsLock(r0);	 Catch:{ all -> 0x00f2 }
            r1 = r1 ^ 1;
            r2 = "Recursive computation";
            com.google.common.base.Preconditions.checkState(r1, r2);	 Catch:{ all -> 0x00f2 }
            r1 = r0.getValueReference();	 Catch:{ all -> 0x00f2 }
            r1 = r1.waitForValue();	 Catch:{ all -> 0x00f2 }
