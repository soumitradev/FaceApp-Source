...
public final class ImmutableRangeSet<C extends Comparable> extends AbstractRangeSet<C> implements Serializable {
            ...
            if (range.isEmpty()) {
                ...
                for (Range<C> currentRange : this.rangeSet.asRanges()) {
                    ...
                    if (currentRange.isConnected(range)) {
                        if (!currentRange.intersection(range).isEmpty()) {
                            z = false;
    ...
    private final class AsSet extends ImmutableSortedSet<C> {
        ...
        class C12711 extends AbstractIterator<C> {
        ...
        class C12722 extends AbstractIterator<C> {
            Iterator<C> elemItr = Iterators.emptyIterator();
        ...
        public int size() {
            ...
            if (result == null) {
                ...
                while (i$.hasNext()) {
                    long total2 = total + ((long) ContiguousSet.create((Range) i$.next(), this.domain).size());
