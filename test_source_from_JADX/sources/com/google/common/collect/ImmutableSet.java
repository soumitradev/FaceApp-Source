...
public abstract class ImmutableSet<E> extends ImmutableCollection<E> implements Set<E> {
    ...
    static abstract class Indexed<E> extends ImmutableSet<E> {
        ...
        class C13431 extends ImmutableAsList<E> {
            C13431() {
            }
    ...
    private static <E> ImmutableSet<E> construct(int n, Object... elements) {
        switch (n) {
            ...
            default:
                ...
                return new RegularImmutableSet(uniques < elements.length ? ObjectArrays.arraysCopyOf(elements, uniques) : elements, hashCode, table, mask);
        }
    }
