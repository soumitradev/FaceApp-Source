...
public final class Maps {
    ...
    public static <K, V> ImmutableMap<K, V> uniqueIndex(Iterator<V> values, Function<? super V, K> keyFunction) {
        ...
        try {
            ...
            stringBuilder.append(duplicateKeys.getMessage());
    ...
    static <K, V> UnmodifiableIterator<Entry<K, V>> unmodifiableEntryIterator(Iterator<Entry<K, V>> entryIterator) {
        return new Maps$6(entryIterator);
    }
    ...
    public static <K, V1, V2> Map<K, V2> transformEntries(Map<K, V1> fromMap, Maps$EntryTransformer<? super K, ? super V1, V2> transformer) {
        if (fromMap instanceof SortedMap) {
            return transformEntries((SortedMap) fromMap, (Maps$EntryTransformer) transformer);
        }
    ...
    static <K, V1, V2> Function<V1, V2> asValueToValueFunction(Maps$EntryTransformer<? super K, V1, V2> transformer, K key) {
        ...
        return new Maps$8(transformer, key);
    }

    static <K, V1, V2> Function<Entry<K, V1>, V2> asEntryToValueFunction(Maps$EntryTransformer<? super K, ? super V1, V2> transformer) {
        Preconditions.checkNotNull(transformer);
        return new Maps$9(transformer);
    }

    static <V2, K, V1> Entry<K, V2> transformEntry(Maps$EntryTransformer<? super K, ? super V1, V2> transformer, Entry<K, V1> entry) {
        Preconditions.checkNotNull(transformer);
        Preconditions.checkNotNull(entry);
        return new Maps$10(entry, transformer);
    }

    static <K, V1, V2> Function<Entry<K, V1>, Entry<K, V2>> asEntryToEntryFunction(Maps$EntryTransformer<? super K, ? super V1, V2> transformer) {
        Preconditions.checkNotNull(transformer);
        return new Maps$11(transformer);
    }
    ...
    public static <K, V> Map<K, V> filterKeys(Map<K, V> unfiltered, Predicate<? super K> keyPredicate) {
        ...
        return unfiltered instanceof Maps$AbstractFilteredMap ? filterFiltered((Maps$AbstractFilteredMap) unfiltered, entryPredicate) : new Maps$FilteredKeyMap((Map) Preconditions.checkNotNull(unfiltered), keyPredicate, entryPredicate);
    }
    ...
    public static <K, V> Map<K, V> filterEntries(Map<K, V> unfiltered, Predicate<? super Entry<K, V>> entryPredicate) {
        ...
        return unfiltered instanceof Maps$AbstractFilteredMap ? filterFiltered((Maps$AbstractFilteredMap) unfiltered, (Predicate) entryPredicate) : new Maps$FilteredEntryMap((Map) Preconditions.checkNotNull(unfiltered), entryPredicate);
    }
    ...
    static <K, V> SortedMap<K, V> filterSortedIgnoreNavigable(SortedMap<K, V> unfiltered, Predicate<? super Entry<K, V>> entryPredicate) {
        Preconditions.checkNotNull(entryPredicate);
        return unfiltered instanceof Maps$FilteredEntrySortedMap ? filterFiltered((Maps$FilteredEntrySortedMap) unfiltered, (Predicate) entryPredicate) : new Maps$FilteredEntrySortedMap((SortedMap) Preconditions.checkNotNull(unfiltered), entryPredicate);
    }
    ...
    public static <K, V> BiMap<K, V> filterEntries(BiMap<K, V> unfiltered, Predicate<? super Entry<K, V>> entryPredicate) {
        ...
        Preconditions.checkNotNull(entryPredicate);
        return unfiltered instanceof Maps$FilteredEntryBiMap ? filterFiltered((Maps$FilteredEntryBiMap) unfiltered, (Predicate) entryPredicate) : new Maps$FilteredEntryBiMap(unfiltered, entryPredicate);
    }
    ...
    private static <K, V> SortedMap<K, V> filterFiltered(Maps$FilteredEntrySortedMap<K, V> map, Predicate<? super Entry<K, V>> entryPredicate) {
        return new Maps$FilteredEntrySortedMap(map.sortedMap(), Predicates.and(map.predicate, entryPredicate));
    }
    ...
    private static <K, V> BiMap<K, V> filterFiltered(Maps$FilteredEntryBiMap<K, V> map, Predicate<? super Entry<K, V>> entryPredicate) {
        return new Maps$FilteredEntryBiMap(map.unfiltered(), Predicates.and(map.predicate, entryPredicate));
    }

    @GwtIncompatible("NavigableMap")
    public static <K, V> NavigableMap<K, V> unmodifiableNavigableMap(NavigableMap<K, V> map) {
        Preconditions.checkNotNull(map);
        if (map instanceof Maps$UnmodifiableNavigableMap) {
            return map;
        }
        return new Maps$UnmodifiableNavigableMap(map);
    }
