...
class StandardTable$Column extends Maps$ViewCachingAbstractMap<R, V> {
    final C columnKey;
    ...
    private class EntrySet extends Sets$ImprovedAbstractSet<Entry<R, V>> {
        ...
        public boolean isEmpty() {
            return StandardTable$Column.this.this$0.containsColumn(StandardTable$Column.this.columnKey) ^ 1;
        }
