...
public final class Tables {
    private static final Function<? extends Map<?, ?>, ? extends Map<?, ?>> UNMODIFIABLE_WRAPPER = new C09731();

    /* renamed from: com.google.common.collect.Tables$1 */
    static class C09731 implements Function<Map<Object, Object>, Map<Object, Object>> {
        C09731() {
        }
    ...
    private static class TransformedTable<R, C, V1, V2> extends AbstractTable<R, C, V2> {
        ...
        class C09741 implements Function<Cell<R, C, V1>, Cell<R, C, V2>> {
            C09741() {
            }
        ...
        class C09752 implements Function<Map<C, V1>, Map<C, V2>> {
            C09752() {
            }
        ...
        class C09763 implements Function<Map<R, V1>, Map<R, V2>> {
            C09763() {
            }
        ...
        public Map<R, Map<C, V2>> rowMap() {
            return Maps.transformValues(this.fromTable.rowMap(), new C09752());
        }

        public Map<C, Map<R, V2>> columnMap() {
            return Maps.transformValues(this.fromTable.columnMap(), new C09763());
        }
    }

    private static class TransposeTable<C, R, V> extends AbstractTable<C, R, V> {
        private static final Function<Cell<?, ?, ?>, Cell<?, ?, ?>> TRANSPOSE_CELL = new C09771();
        final Table<R, C, V> original;

        /* renamed from: com.google.common.collect.Tables$TransposeTable$1 */
        static class C09771 implements Function<Cell<?, ?, ?>, Cell<?, ?, ?>> {
            C09771() {
            }
