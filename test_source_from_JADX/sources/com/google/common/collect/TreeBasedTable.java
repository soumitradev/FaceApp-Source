...
public class TreeBasedTable<R, C, V> extends StandardRowSortedTable<R, C, V> {
    ...
    class C09781 implements Function<Map<C, V>, Iterator<C>> {
        C09781() {
        }
    ...
    public SortedMap<C, V> row(R rowKey) {
        return new TreeBasedTable$TreeRow(this, rowKey);
    }
    ...
    Iterator<C> createColumnKeyIterator() {
        ...
        final Iterator<C> merged = Iterators.mergeSorted(Iterables.transform(this.backingMap.values(), new C09781()), comparator);
