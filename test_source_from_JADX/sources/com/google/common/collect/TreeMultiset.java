...
public final class TreeMultiset<E> extends AbstractSortedMultiset<E> implements Serializable {
    ...
    private long aggregateBelowRange(TreeMultiset$Aggregate aggr, @Nullable AvlNode<E> node) {
        if (node == null) {
            return 0;
        }
    ...
    private long aggregateAboveRange(TreeMultiset$Aggregate aggr, @Nullable AvlNode<E> node) {
        if (node == null) {
            return 0;
        }
    ...
    private Entry<E> wrapEntry(AvlNode<E> baseEntry) {
        return new TreeMultiset$1(this, baseEntry);
    }
    ...
    private AvlNode<E> firstNode() {
        ...
        if (node2 != this.header) {
            if (this.range.contains(node2.getElement())) {
                avlNode = node2;
            }
        }
        return avlNode;
