...
class TreeRangeMap$SubRangeMap$SubRangeMapAsMap extends AbstractMap<Range<K>, V> {
    ...
    class C13012 extends Maps$EntrySet<Range<K>, V> {
        C13012() {
        }
    ...
    public V get(Object key) {
        try {
            if (key instanceof Range) {
                Range<K> r = (Range) key;
                if (SubRangeMap.access$200(this.this$1).encloses(r)) {
                    if (!r.isEmpty()) {
                        TreeRangeMap$RangeMapEntry<K, V> candidate = null;
                        if (r.lowerBound.compareTo(SubRangeMap.access$200(this.this$1).lowerBound) == 0) {
                            Entry<Cut<K>, TreeRangeMap$RangeMapEntry<K, V>> entry = TreeRangeMap.access$000(this.this$1.this$0).floorEntry(r.lowerBound);
                            if (entry != null) {
                                candidate = (TreeRangeMap$RangeMapEntry) entry.getValue();
                            }
                        } else {
                            candidate = (TreeRangeMap$RangeMapEntry) TreeRangeMap.access$000(this.this$1.this$0).get(r.lowerBound);
                        }
                        if (candidate != null && candidate.getKey().isConnected(SubRangeMap.access$200(this.this$1)) && candidate.getKey().intersection(SubRangeMap.access$200(this.this$1)).equals(r)) {
    ...
    Iterator<Entry<Range<K>, V>> entryIterator() {
        ...
        final Iterator<TreeRangeMap$RangeMapEntry<K, V>> backingItr = TreeRangeMap.access$000(this.this$1.this$0).tailMap((Cut) MoreObjects.firstNonNull(TreeRangeMap.access$000(this.this$1.this$0).floorKey(SubRangeMap.access$200(this.this$1).lowerBound), SubRangeMap.access$200(this.this$1).lowerBound), true).values().iterator();
        return new AbstractIterator<Entry<Range<K>, V>>() {
            protected Entry<Range<K>, V> computeNext() {
                while (backingItr.hasNext()) {
                    ...
                    if (entry.getLowerBound().compareTo(SubRangeMap.access$200(TreeRangeMap$SubRangeMap$SubRangeMapAsMap.this.this$1).upperBound) >= 0) {
                        return (Entry) endOfData();
                    }
                    if (entry.getUpperBound().compareTo(SubRangeMap.access$200(TreeRangeMap$SubRangeMap$SubRangeMapAsMap.this.this$1).lowerBound) > 0) {
                        return Maps.immutableEntry(entry.getKey().intersection(SubRangeMap.access$200(TreeRangeMap$SubRangeMap$SubRangeMapAsMap.this.this$1)), entry.getValue());
                    }
                }
                return (Entry) endOfData();
            }
