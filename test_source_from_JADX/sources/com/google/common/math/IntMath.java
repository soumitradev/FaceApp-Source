...
public final class IntMath {
    ...
    private static final int[] factorials = new int[]{1, 1, 2, 6, 24, 120, ScreenValues.CAST_SCREEN_HEIGHT, 5040, 40320, 362880, 3628800, 39916800, 479001600};
    @VisibleForTesting
    ...
    @VisibleForTesting
    static final int[] powersOf10 = new int[]{1, 10, 100, 1000, 10000, BZip2Constants.BASEBLOCKSIZE, 1000000, 10000000, 100000000, 1000000000};
    ...
    public static int log2(int x, RoundingMode mode) {
        ...
        switch (C05771.$SwitchMap$java$math$RoundingMode[mode.ordinal()]) {
            case 1:
