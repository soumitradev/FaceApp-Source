...
public final class MediaType {
    ...
    class C09981 implements Function<Collection<String>, ImmutableMultiset<String>> {
        C09981() {
        }
    ...
    class C09992 implements Function<String, String> {
        C09992() {
        }
    ...
    private Map<String, ImmutableMultiset<String>> parametersAsMap() {
        return Maps.transformValues(this.parameters.asMap(), new C09981());
    }
    ...
    private static MediaType create(String type, String subtype, Multimap<String, String> parameters) {
        ...
        if (WILDCARD.equals(normalizedType)) {
            if (!WILDCARD.equals(normalizedSubtype)) {
                z = false;
        ...
        Preconditions.checkArgument(z, "A wildcard type cannot be used with a non-wildcard subtype");
        builder = ImmutableListMultimap.builder();
        for (Entry<String, String> entry2 : parameters.entries()) {
            Object attribute2 = normalizeToken((String) entry2.getKey());
            builder.put(attribute2, normalizeParameterValue(attribute2, (String) entry2.getValue()));
        }
        mediaType = new MediaType(normalizedType, normalizedSubtype, builder.build());
        return (MediaType) MoreObjects.firstNonNull(KNOWN_TYPES.get(mediaType), mediaType);
    }
    ...
    public static MediaType parse(String input) {
        ...
        try {
            ...
            while (tokenizer.hasMore()) {
                String value;
                tokenizer.consumeCharacter((char) Constants.REMIX_URL_REPLACE_SEPARATOR);
    ...
    private String computeToString() {
        ...
        if (!this.parameters.isEmpty()) {
            builder.append("; ");
            PARAMETER_JOINER.appendTo(builder, Multimaps.transformValues(this.parameters, new C09992()).entries());
        }
