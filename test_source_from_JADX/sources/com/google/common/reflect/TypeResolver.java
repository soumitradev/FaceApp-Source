...
public final class TypeResolver {
    ...
    private static class TypeTable {
        ...
        final TypeTable where(Map<TypeVariableKey, ? extends Type> mappings) {
            ...
            for (Entry<TypeVariableKey, ? extends Type> mapping : mappings.entrySet()) {
                ...
                Preconditions.checkArgument(variable.equalsType(type) ^ true, "Type variable %s bound to itself", variable);
    ...
    private static final class WildcardCapturer {
        ...
        Type capture(Type type) {
            ...
            if (type instanceof ParameterizedType) {
                ...
                name.append(Joiner.on(Typography.amp).join(upperBounds));
    ...
    private static void populateTypeMappings(final Map<TypeVariableKey, Type> mappings, Type from, final Type to) {
        if (!from.equals(to) && (to instanceof WildcardType) == (from instanceof WildcardType)) {
            new TypeVisitor() {
