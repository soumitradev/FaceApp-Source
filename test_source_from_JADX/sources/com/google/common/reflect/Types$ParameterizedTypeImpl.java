...
final class Types$ParameterizedTypeImpl implements ParameterizedType, Serializable {
    ...
    public String toString() {
        ...
        if (this.ownerType != null) {
            builder.append(Types$JavaVersion.CURRENT.typeName(this.ownerType));
            builder.append('.');
        }
        builder.append(this.rawType.getName());
        builder.append(Typography.less);
        builder.append(Types.access$500().join(Iterables.transform(this.argumentsList, Types.access$400())));
