...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C06151();
    ...
    static class C06151 implements Comparator<Comparable> {
        C06151() {
        }
    ...
    final class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C10551 extends LinkedTreeMapIterator<Entry<K, V>> {
            C10551() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C10561 extends LinkedTreeMapIterator<K> {
            C10561() {
                super();
            }
