...
public final class MapTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken) {
        MapTypeAdapterFactory mapTypeAdapterFactory = this;
        Gson gson2 = gson;
        ...
        return new Adapter(gson2, keyAndValueTypes[0], keyAdapter, keyAndValueTypes[1], gson2.getAdapter(TypeToken.get(keyAndValueTypes[1])), mapTypeAdapterFactory.constructorConstructor.get(typeToken));
    }
