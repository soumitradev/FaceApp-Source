...
public final class HttpDate {
    ...
    private static final ThreadLocal<DateFormat> STANDARD_DATE_FORMAT = new C06501();

    /* renamed from: com.koushikdutta.async.http.HttpDate$1 */
    static class C06501 extends ThreadLocal<DateFormat> {
        C06501() {
        }
