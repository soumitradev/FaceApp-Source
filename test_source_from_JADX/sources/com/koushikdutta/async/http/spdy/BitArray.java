...
interface BitArray {
    ...
    public static final class FixedCapacity implements BitArray {
        ...
        private static int checkInput(int index) {
            ...
            throw new IllegalArgumentException(String.format(Locale.ENGLISH, "input must be between 0 and 63: %s", new Object[]{Integer.valueOf(index)}));
        }
    }
    ...
    public static final class VariableCapacity implements BitArray {
        ...
        public String toString() {
            ...
            for (int i = 0; i < count; i++) {
                if (i > 0) {
                    builder.append(Constants.REMIX_URL_SEPARATOR);
                }
        ...
        private static int checkInput(int index) {
            ...
            throw new IllegalArgumentException(String.format(Locale.ENGLISH, "input must be a positive number: %s", new Object[]{Integer.valueOf(index)}));
        }
    }
