...
public enum ARCOMMANDS_ARDRONE3_ANIMATIONS_FLIP_DIRECTION_ENUM {
    ...
    private ARCOMMANDS_ARDRONE3_ANIMATIONS_FLIP_DIRECTION_ENUM(int value) {
        this.value = value;
        this.comment = null;
    }

    private ARCOMMANDS_ARDRONE3_ANIMATIONS_FLIP_DIRECTION_ENUM(int value, String comment) {
        this.value = value;
    ...
    public static ARCOMMANDS_ARDRONE3_ANIMATIONS_FLIP_DIRECTION_ENUM getFromValue(int value) {
        if (valuesList == null) {
            ARCOMMANDS_ARDRONE3_ANIMATIONS_FLIP_DIRECTION_ENUM[] valuesArray = values();
            valuesList = new HashMap(valuesArray.length);
            for (ARCOMMANDS_ARDRONE3_ANIMATIONS_FLIP_DIRECTION_ENUM entry : valuesArray) {
                valuesList.put(Integer.valueOf(entry.getValue()), entry);
            }
        }
        ARCOMMANDS_ARDRONE3_ANIMATIONS_FLIP_DIRECTION_ENUM retVal = (ARCOMMANDS_ARDRONE3_ANIMATIONS_FLIP_DIRECTION_ENUM) valuesList.get(Integer.valueOf(value));
        if (retVal == null) {
            return eARCOMMANDS_ARDRONE3_ANIMATIONS_FLIP_DIRECTION_UNKNOWN_ENUM_VALUE;
        }
        return retVal;
    }
