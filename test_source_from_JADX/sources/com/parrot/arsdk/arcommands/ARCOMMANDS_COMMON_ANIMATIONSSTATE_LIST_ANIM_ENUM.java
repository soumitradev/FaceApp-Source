...
public enum ARCOMMANDS_COMMON_ANIMATIONSSTATE_LIST_ANIM_ENUM {
    ...
    private ARCOMMANDS_COMMON_ANIMATIONSSTATE_LIST_ANIM_ENUM(int value) {
        this.value = value;
        this.comment = null;
    }

    private ARCOMMANDS_COMMON_ANIMATIONSSTATE_LIST_ANIM_ENUM(int value, String comment) {
        this.value = value;
    ...
    public static ARCOMMANDS_COMMON_ANIMATIONSSTATE_LIST_ANIM_ENUM getFromValue(int value) {
        if (valuesList == null) {
            ARCOMMANDS_COMMON_ANIMATIONSSTATE_LIST_ANIM_ENUM[] valuesArray = values();
            valuesList = new HashMap(valuesArray.length);
            for (ARCOMMANDS_COMMON_ANIMATIONSSTATE_LIST_ANIM_ENUM entry : valuesArray) {
                valuesList.put(Integer.valueOf(entry.getValue()), entry);
            }
        }
        ARCOMMANDS_COMMON_ANIMATIONSSTATE_LIST_ANIM_ENUM retVal = (ARCOMMANDS_COMMON_ANIMATIONSSTATE_LIST_ANIM_ENUM) valuesList.get(Integer.valueOf(value));
        if (retVal == null) {
            return eARCOMMANDS_COMMON_ANIMATIONSSTATE_LIST_ANIM_UNKNOWN_ENUM_VALUE;
        }
        return retVal;
    }
