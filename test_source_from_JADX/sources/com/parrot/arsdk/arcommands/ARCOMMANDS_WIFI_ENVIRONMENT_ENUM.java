...
public enum ARCOMMANDS_WIFI_ENVIRONMENT_ENUM {
    ...
    private ARCOMMANDS_WIFI_ENVIRONMENT_ENUM(int value) {
        this.value = value;
        this.comment = null;
    }

    private ARCOMMANDS_WIFI_ENVIRONMENT_ENUM(int value, String comment) {
        this.value = value;
    ...
    public static ARCOMMANDS_WIFI_ENVIRONMENT_ENUM getFromValue(int value) {
        if (valuesList == null) {
            ARCOMMANDS_WIFI_ENVIRONMENT_ENUM[] valuesArray = values();
            valuesList = new HashMap(valuesArray.length);
            for (ARCOMMANDS_WIFI_ENVIRONMENT_ENUM entry : valuesArray) {
                valuesList.put(Integer.valueOf(entry.getValue()), entry);
            }
        }
        ARCOMMANDS_WIFI_ENVIRONMENT_ENUM retVal = (ARCOMMANDS_WIFI_ENVIRONMENT_ENUM) valuesList.get(Integer.valueOf(value));
        if (retVal == null) {
            return UNKNOWN;
        }
        return retVal;
