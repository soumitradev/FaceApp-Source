...
public enum ARDATATRANSFER_DOWNLOADER_RESUME_ENUM {
    ...
    private ARDATATRANSFER_DOWNLOADER_RESUME_ENUM(int value) {
        this.value = value;
        this.comment = null;
    }

    private ARDATATRANSFER_DOWNLOADER_RESUME_ENUM(int value, String comment) {
        this.value = value;
    ...
    public static ARDATATRANSFER_DOWNLOADER_RESUME_ENUM getFromValue(int value) {
        if (valuesList == null) {
            ARDATATRANSFER_DOWNLOADER_RESUME_ENUM[] valuesArray = values();
            valuesList = new HashMap(valuesArray.length);
            for (ARDATATRANSFER_DOWNLOADER_RESUME_ENUM entry : valuesArray) {
                valuesList.put(Integer.valueOf(entry.getValue()), entry);
            }
        }
        ARDATATRANSFER_DOWNLOADER_RESUME_ENUM retVal = (ARDATATRANSFER_DOWNLOADER_RESUME_ENUM) valuesList.get(Integer.valueOf(value));
        if (retVal == null) {
            return eARDATATRANSFER_DOWNLOADER_RESUME_UNKNOWN_ENUM_VALUE;
        }
        return retVal;
    }
