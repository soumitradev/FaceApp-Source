...
public final class Cache {
    ...
    final InternalCache internalCache = new C20281();
    ...
    class C16392 implements Iterator<String> {
        boolean canRemove;
        final Iterator<Snapshot> delegate = Cache.this.cache.snapshots();
        String nextUrl;

        C16392() throws IOException {
        }
    ...
    class C20281 implements InternalCache {
        C20281() {
        }
    ...
    private final class CacheRequestImpl implements CacheRequest {
        ...
        L_0x0009:
            r1 = 1;
            r2.done = r1;	 Catch:{ all -> 0x001f }
            r1 = com.squareup.okhttp.Cache.this;	 Catch:{ all -> 0x001f }
            r1.writeAbortCount = r1.writeAbortCount + 1;	 Catch:{ all -> 0x001f }
            monitor-exit(r0);	 Catch:{ all -> 0x001f }
            r0 = r2.cacheOut;
