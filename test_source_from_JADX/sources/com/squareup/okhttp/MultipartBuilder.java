...
public final class MultipartBuilder {
    ...
    private static final byte[] COLONSPACE = new byte[]{GeneralMidiConstants.TUBA, (byte) 32};
    private static final byte[] CRLF = new byte[]{(byte) 13, (byte) 10};
    private static final byte[] DASHDASH = new byte[]{GeneralMidiConstants.PIZZICATO_STRINGS, GeneralMidiConstants.PIZZICATO_STRINGS};
    public static final MediaType DIGEST = MediaType.parse("multipart/digest");
    public static final MediaType FORM = MediaType.parse(MultipartFormDataBody.CONTENT_TYPE);
