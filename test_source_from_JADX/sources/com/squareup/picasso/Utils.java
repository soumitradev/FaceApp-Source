...
final class Utils {
    ...
    static boolean parseResponseSourceHeader(String header) {
        ...
        String[] parts = header.split(FormatHelper.SPACE, 2);
    ...
    static boolean isWebPFile(InputStream stream) throws IOException {
        ...
        if (WEBP_FILE_HEADER_RIFF.equals(new String(fileHeaderBytes, 0, 4, CharsetNames.US_ASCII)) && WEBP_FILE_HEADER_WEBP.equals(new String(fileHeaderBytes, 8, 4, CharsetNames.US_ASCII))) {
            z = true;
        }
        return z;
    }
    ...
    static int getResourceId(Resources resources, Request data) throws FileNotFoundException {
        if (data.resourceId == 0) {
            if (data.uri != null) {
                    ...
                    if (!segments.isEmpty()) {
                        ...
                        if (segments.size() == 1) {
                            try {
                                ...
                                stringBuilder3.append("Last path segment is not a resource ID: ");
                                stringBuilder3.append(data.uri);
                            ...
                            stringBuilder2.append(data.uri);
                ...
                stringBuilder2 = new StringBuilder();
                stringBuilder2.append("No path segments: ");
                stringBuilder2.append(data.uri);
                throw new FileNotFoundException(stringBuilder2.toString());
            }
        }
        ...
        if (data.resourceId == 0) {
            if (data.uri != null) {
                ...
                try {
                    ...
                    stringBuilder2.append("Unable to obtain resources for package: ");
                    stringBuilder2.append(data.uri);
                    throw new FileNotFoundException(stringBuilder2.toString());
                }
            }
