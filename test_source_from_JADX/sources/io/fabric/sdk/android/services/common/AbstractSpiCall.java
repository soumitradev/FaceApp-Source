...
public abstract class AbstractSpiCall {
    ...
    protected HttpRequest getHttpRequest(Map<String, String> queryParams) {
        ...
        return this.requestFactory.buildHttpRequest(this.method, getUrl(), queryParams).useCaches(false).connectTimeout(10000).header("User-Agent", stringBuilder.toString()).header(HEADER_DEVELOPER_TOKEN, "470fa2b4ae81cd56ecbcda9735803434cec591fa");
    }
