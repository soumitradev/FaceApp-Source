...
public abstract class AsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory threadFactory = new C17011();
    ...
    private final WorkerRunnable<Params, Result> worker = new C20782();

    /* renamed from: io.fabric.sdk.android.services.concurrency.AsyncTask$1 */
    static class C17011 implements ThreadFactory {
    ...
    class C20782 extends WorkerRunnable<Params, Result> {
        C20782() {
            super();
        }
