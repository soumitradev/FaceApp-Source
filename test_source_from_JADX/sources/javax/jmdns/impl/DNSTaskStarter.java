...
public interface DNSTaskStarter {
    ...
    public static final class DNSTaskStarterImpl implements DNSTaskStarter {
        ...
        public DNSTaskStarterImpl(JmDNSImpl jmDNSImpl) {
            ...
            stringBuilder.append("JmDNS(");
            stringBuilder.append(this._jmDNSImpl.getName());
            stringBuilder.append(").Timer");
            this._timer = new StarterTimer(stringBuilder.toString(), true);
            stringBuilder = new StringBuilder();
            stringBuilder.append("JmDNS(");
            stringBuilder.append(this._jmDNSImpl.getName());
            stringBuilder.append(").State.Timer");
            this._stateTimer = new StarterTimer(stringBuilder.toString(), false);
        }
