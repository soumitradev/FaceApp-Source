...
public enum DNSRecordType {
    ...
    TYPE_TKEY("tkey", 249),
    TYPE_TSIG("tsig", 250),
    TYPE_IXFR("ixfr", Keys.F8),
    TYPE_AXFR("axfr", Keys.F9),
    TYPE_MAILA("mails", Keys.F10),
    TYPE_MAILB("mailb", Keys.F11),
    TYPE_ANY("any", 255);
    ...
    public static DNSRecordType typeForName(String name) {
        ...
        stringBuilder.append("Could not find record type for name: ");
    ...
    public static DNSRecordType typeForIndex(int index) {
        ...
        Logger logger = logger;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("Could not find record type for index: ");
