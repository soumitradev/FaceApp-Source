...
class CollectionsKt__IterablesKt extends CollectionsKt__CollectionsKt {
    ...
    public static final <T> Collection<T> convertToSetForSetOperationWith(@NotNull Iterable<? extends T> $receiver, @NotNull Iterable<? extends T> source) {
        ...
        if ($receiver instanceof Set) {
            ...
            collection = CollectionsKt___CollectionsKt.toHashSet($receiver);
        } else if (!(source instanceof Collection) || ((Collection) source).size() >= 2) {
            collection = safeToConvertToSet$CollectionsKt__IterablesKt((Collection) $receiver) ? CollectionsKt___CollectionsKt.toHashSet($receiver) : (Collection) $receiver;
        } else {
            collection = (Collection) $receiver;
        }
        return collection;
    ...
    public static final <T> Collection<T> convertToSetForSetOperation(@NotNull Iterable<? extends T> $receiver) {
        Intrinsics.checkParameterIsNotNull($receiver, "$receiver");
        Collection<T> toHashSet = $receiver instanceof Set ? (Collection) $receiver : $receiver instanceof Collection ? safeToConvertToSet$CollectionsKt__IterablesKt((Collection) $receiver) ? CollectionsKt___CollectionsKt.toHashSet($receiver) : (Collection) $receiver : CollectionsKt___CollectionsKt.toHashSet($receiver);
        return toHashSet;
    }
