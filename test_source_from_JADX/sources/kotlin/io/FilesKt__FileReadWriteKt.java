...
class FilesKt__FileReadWriteKt extends FilesKt__FilePathComponentsKt {
    ...
    @InlineOnly
    static /* synthetic */ InputStreamReader reader$default(File $receiver, Charset charset, int i, Object obj) {
        if ((i & 1) != null) {
    ...
    @InlineOnly
    static /* synthetic */ BufferedReader bufferedReader$default(File $receiver, Charset charset, int bufferSize, int i, Object obj) {
        if ((i & 1) != null) {
            charset = Charsets.UTF_8;
        }
        if ((i & 2) != null) {
    ...
    @InlineOnly
    static /* synthetic */ OutputStreamWriter writer$default(File $receiver, Charset charset, int i, Object obj) {
        if ((i & 1) != null) {
            charset = Charsets.UTF_8;
        }
    ...
    @InlineOnly
    static /* synthetic */ BufferedWriter bufferedWriter$default(File $receiver, Charset charset, int bufferSize, int i, Object obj) {
        if ((i & 1) != null) {
            charset = Charsets.UTF_8;
        }
        if ((i & 2) != null) {
    ...
    @InlineOnly
    static /* synthetic */ PrintWriter printWriter$default(File $receiver, Charset charset, int i, Object obj) {
        if ((i & 1) != null) {
            charset = Charsets.UTF_8;
        }
        Writer outputStreamWriter = new OutputStreamWriter(new FileOutputStream($receiver), charset);
    ...
    L_0x005f:
        ...
        r8 = "java.util.Arrays.copyOf(this, newSize)";
    ...
    public static final void forEachBlock(@org.jetbrains.annotations.NotNull java.io.File r7, int r8, @org.jetbrains.annotations.NotNull kotlin.jvm.functions.Function2<? super byte[], ? super java.lang.Integer, kotlin.Unit> r9) {
        ...
        r3 = r1;
        r3 = (java.io.FileInputStream) r3;	 Catch:{ Throwable -> 0x003a }
        r4 = 0;
        r5 = r3.read(r0);	 Catch:{ Throwable -> 0x003a }
        if (r5 > 0) goto L_0x002f;
        r3 = kotlin.Unit.INSTANCE;	 Catch:{ Throwable -> 0x003a }
        kotlin.io.CloseableKt.closeFinally(r1, r2);
        return;
    L_0x002f:
        r6 = java.lang.Integer.valueOf(r5);	 Catch:{ Throwable -> 0x003a }
    ...
    L_0x0032:
        ...
        r3 = r8.invoke(r5);	 Catch:{ Throwable -> 0x005b }
    ...
    L_0x002d:
        ...
        r5 = r10.invoke(r7);	 Catch:{ Throwable -> 0x0056 }
