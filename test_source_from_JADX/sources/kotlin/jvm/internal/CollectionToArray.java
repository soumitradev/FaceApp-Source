    ...
    public static final Object[] toArray(@NotNull Collection<?> collection, @Nullable Object[] a) {
        ...
        if (size$iv == 0) {
            ...
            if (iter$iv.hasNext()) {
                ...
                Object[] result$iv2 = result$iv;
                size = 0;
                while (true) {
                    i$iv = size + 1;
                    result$iv2[size] = iter$iv.next();
                    if (i$iv >= result$iv2.length) {
                        ...
                        Object copyOf = Arrays.copyOf(result$iv2, size);
                        Intrinsics.checkExpressionValueIsNotNull(copyOf, "Arrays.copyOf(result, newSize)");
                        result$iv2 = copyOf;
                    } else if (!iter$iv.hasNext()) {
                        break;
                ...
                if (result$iv == a) {
                    ...
                    objArr = Arrays.copyOf(result$iv, size2);
