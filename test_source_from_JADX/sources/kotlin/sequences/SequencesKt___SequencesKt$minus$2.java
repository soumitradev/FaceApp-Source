...
public final class SequencesKt___SequencesKt$minus$2 implements Sequence<T> {
    ...
    public Iterator<T> iterator() {
        return SequencesKt___SequencesKt.filterNot(this.receiver$0, new SequencesKt___SequencesKt$minus$2$iterator$1(ArraysKt___ArraysKt.toHashSet((Object[]) this.$elements))).iterator();
    }
}
