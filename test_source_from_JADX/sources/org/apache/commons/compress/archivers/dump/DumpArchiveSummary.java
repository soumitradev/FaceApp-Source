...
public class DumpArchiveSummary {
    ...
    DumpArchiveSummary(byte[] buffer, ZipEncoding encoding) throws IOException {
        ...
        this.ntrec = DumpArchiveUtil.convert32(buffer, MediaRouterJellybean.DEVICE_OUT_BLUETOOTH);
    }
    ...
    public int hashCode() {
        ...
        hash = (int) (((long) hash) + (this.dumpDate * 31));
    ...
    public boolean equals(Object o) {
        ...
        if (o != null) {
            if (o.getClass().equals(getClass())) {
                ...
                if (this.dumpDate == rhs.dumpDate && getHostname() != null) {
                    if (getHostname().equals(rhs.getHostname())) {
                        if (getDevname() != null) {
                            if (getDevname().equals(rhs.getDevname())) {
                                return true;
                            }
                        }
                        return false;
