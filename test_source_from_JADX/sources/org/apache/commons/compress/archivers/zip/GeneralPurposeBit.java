...
public final class GeneralPurposeBit {
    ...
    public byte[] encode() {
        int i = 0;
        int i2 = ((this.dataDescriptorFlag ? 8 : 0) | (this.languageEncodingFlag ? 2048 : 0)) | this.encryptionFlag;
    ...
    public int hashCode() {
        return ((((((this.encryptionFlag * 17) + this.strongEncryptionFlag) * 13) + this.languageEncodingFlag) * 7) + this.dataDescriptorFlag) * 3;
    }
