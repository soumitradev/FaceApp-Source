...
class Simple8BitZipEncoding implements ZipEncoding {
    ...
    private static final class Simple8BitChar implements Comparable<Simple8BitChar> {
        ...
        public String toString() {
            ...
            stringBuilder.append(Integer.toHexString(this.unicode & SupportMenu.USER_MASK));
            stringBuilder.append("->0x");
            stringBuilder.append(Integer.toHexString(this.code & 255));
