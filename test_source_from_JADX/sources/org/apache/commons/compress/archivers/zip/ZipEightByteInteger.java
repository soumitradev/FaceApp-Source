...
public final class ZipEightByteInteger implements Serializable {
    ...
    public static byte[] getBytes(BigInteger value) {
        ...
        result[0] = (byte) ((int) (val & 255));
        result[1] = (byte) ((int) ((val & 65280) >> 8));
        result[2] = (byte) ((int) ((val & 16711680) >> 16));
        result[3] = (byte) ((int) ((val & BYTE_3_MASK) >> 24));
        result[4] = (byte) ((int) ((val & BYTE_4_MASK) >> 32));
        result[5] = (byte) ((int) ((val & BYTE_5_MASK) >> 40));
        result[6] = (byte) ((int) ((val & BYTE_6_MASK) >> 48));
        result[7] = (byte) ((int) ((val & BYTE_7_MASK) >> 56));
        if (value.testBit(63)) {
    ...
    public String toString() {
        ...
        stringBuilder.append("ZipEightByteInteger value: ");
