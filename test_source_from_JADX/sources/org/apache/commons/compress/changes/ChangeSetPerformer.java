...
public class ChangeSetPerformer {
    ...
    private static class ZipFileIterator implements ArchiveEntryIterator {
        ...
        public ArchiveEntry next() {
            ZipArchiveEntry zipArchiveEntry = (ZipArchiveEntry) this.nestedEnum.nextElement();
            this.current = zipArchiveEntry;
            ...
            while (it2.hasNext()) {
                ...
                if (type != 1 || name == null) {
                    if (type == 4 && name != null) {
                        ...
                        stringBuilder.append(change2.targetFile());
        ...
        if (!workingSet.isEmpty()) {
            for (Change change : workingSet) {
                ...
                if (type == 4) {
                    ...
                    stringBuilder.append("/");
                    if (source.startsWith(stringBuilder.toString())) {
                        return true;
                    }
                }
            }
