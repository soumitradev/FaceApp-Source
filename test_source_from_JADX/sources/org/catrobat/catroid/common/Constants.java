...
public final class Constants {
    ...
    public static final int CAST_IDLE_BACKGROUND_COLOR = 1711276032;
    ...
    public static final String CATROBAT_DELETE_ACCOUNT_URL = "https://share.catrob.at/pocketcode/profile/edit";
    public static final String CATROBAT_EXTENSION = ".catrobat";
    public static final String CATROBAT_HELP_URL = "https://share.catrob.at/pocketcode/help";
    public static final String CATROBAT_TERMS_OF_USE_URL = "https://share.catrob.at/pocketcode/termsOfUse";
    public static final String CATROBAT_TOKEN_LOGIN_AMP_TOKEN = "&token=";
    public static final String CATROBAT_TOKEN_LOGIN_URL = "https://share.catrob.at/pocketcode/tokenlogin?username=";
    ...
    public static final float COLLISION_WITH_FINGER_TOUCH_RADIUS = 50.0f;
    ...
    public static final int DOWNLOAD_FILE_HTTP_TIMEOUT = 30000;
    ...
    public static final String[] IMAGE_EXTENSIONS = new String[]{DEFAULT_IMAGE_EXTENSION, ARMediaManager.ARMEDIA_MANAGER_JPG, ".jpeg", DEFAULT_IMAGE_EXTENSION, ".gif"};
    ...
    public static final String RASPI_BROADCAST_INTERRUPT_PREFIX = "#RASPI#interrupt ";
    ...
    public static final String SCRATCH_CONVERTER_API_BASE_URL = "http://scratch2.catrob.at/api/v1/";
    public static final String SCRATCH_CONVERTER_API_DEFAULT_PROJECTS_URL = "http://scratch2.catrob.at/api/v1/projects/";
    public static final String SCRATCH_CONVERTER_BASE_URL = "http://scratch2.catrob.at/";
    ...
    public static final String SCRATCH_CONVERTER_WEB_SOCKET = "ws://scratch2.catrob.at/convertersocket";
    public static final int SCRATCH_HTTP_REQUEST_MAX_NUM_OF_RETRIES = 2;
    public static final int SCRATCH_HTTP_REQUEST_MIN_TIMEOUT = 1000;
    ...
    public static final int SCRATCH_SECOND_RELEASE_PUBLISHED_DATE_MONTH = 4;
    ...
    public static final String[] SOUND_EXTENSIONS = new String[]{DEFAULT_SOUND_EXTENSION, ".mp3", ".mpga", DEFAULT_SOUND_EXTENSION, ".ogy"};
    ...
    public static final String TEXT_TO_SPEECH_TMP_PATH;
    public static final int THINK_BRICK = 1;
    public static final String TMP_CODE_XML_FILE_NAME = "tmp_code.xml";
    public static final String TMP_LOOKS_PATH;
    public static final String TMP_PATH;
    public static final String TMP_SOUNDS_PATH;
    ...
    public static final int Z_INDEX_FIRST_SPRITE = 2;
    ...
    static {
        ...
        stringBuilder.append(FlavoredConstants.DEFAULT_ROOT_DIRECTORY.getAbsolutePath());
        stringBuilder.append("/tmp");
        TMP_PATH = stringBuilder.toString();
        stringBuilder = new StringBuilder();
        stringBuilder.append(TMP_PATH);
        stringBuilder.append("/textToSpeech");
        TEXT_TO_SPEECH_TMP_PATH = stringBuilder.toString();
        stringBuilder = new StringBuilder();
        stringBuilder.append(TMP_PATH);
        stringBuilder.append("/looks");
        TMP_LOOKS_PATH = stringBuilder.toString();
        stringBuilder = new StringBuilder();
        stringBuilder.append(TMP_PATH);
        stringBuilder.append("/sounds");
        TMP_SOUNDS_PATH = stringBuilder.toString();
    }
