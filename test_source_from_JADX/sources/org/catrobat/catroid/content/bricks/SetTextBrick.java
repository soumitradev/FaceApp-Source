...
public class SetTextBrick extends FormulaBrick implements OnClickListener {
    ...
    public SetTextBrick(int xDestinationValue, int yDestinationValue, String text) {
        this(new Formula(Integer.valueOf(xDestinationValue)), new Formula(Integer.valueOf(yDestinationValue)), new Formula(text));
    }
    ...
    public List<ScriptSequenceAction> addActionToSequence(Sprite sprite, ScriptSequenceAction sequence) {
        sequence.addAction(sprite.getActionFactory().createSetTextAction(sprite, getFormulaWithBrickField(BrickField.X_DESTINATION), getFormulaWithBrickField(BrickField.Y_DESTINATION), getFormulaWithBrickField(BrickField.STRING)));
        return null;
    }
}
