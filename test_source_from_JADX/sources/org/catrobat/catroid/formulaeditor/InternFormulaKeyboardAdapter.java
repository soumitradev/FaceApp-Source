...
public class InternFormulaKeyboardAdapter {
    ...
    public List<InternToken> createInternTokenListByResourceId(int resource, String name) {
        ...
        if (resource == 2 && !name.isEmpty()) {
            return buildCollideWithFormula(name);
        }
        if (resource == 1 && !name.isEmpty()) {
        ...
        switch (resource) {
            case R.id.formula_editor_keyboard_0:
                return buildNumber(AppEventsConstants.EVENT_PARAM_VALUE_NO);
            case R.id.formula_editor_keyboard_1:
                return buildNumber(AppEventsConstants.EVENT_PARAM_VALUE_YES);
                            ...
                            default:
                                switch (resource) {
                                    case R.string.formula_editor_function_arduino_read_pin_value_analog:
                                        return buildSingleParameterFunction(Functions.ARDUINOANALOG, InternTokenType.NUMBER, AppEventsConstants.EVENT_PARAM_VALUE_NO);
                                    case R.string.formula_editor_function_arduino_read_pin_value_digital:
                                        return buildSingleParameterFunction(Functions.ARDUINODIGITAL, InternTokenType.NUMBER, AppEventsConstants.EVENT_PARAM_VALUE_NO);
                                            ...
                                            default:
                                                switch (resource) {
                                                    ...
                                                    case R.string.formula_editor_function_is_multi_finger_touching:
                                                        return buildSingleParameterFunction(Functions.MULTI_FINGER_TOUCHED, InternTokenType.NUMBER, AppEventsConstants.EVENT_PARAM_VALUE_YES);
                                                    ...
                                                    default:
                                                        switch (resource) {
                                                            case R.string.formula_editor_function_multi_finger_x:
                                                                return buildSingleParameterFunction(Functions.MULTI_FINGER_X, InternTokenType.NUMBER, AppEventsConstants.EVENT_PARAM_VALUE_YES);
                                                            case R.string.formula_editor_function_multi_finger_y:
                                                                return buildSingleParameterFunction(Functions.MULTI_FINGER_Y, InternTokenType.NUMBER, AppEventsConstants.EVENT_PARAM_VALUE_YES);
                                                            default:
                                                                switch (resource) {
                                                                    case R.string.formula_editor_function_raspi_read_pin_value_digital:
                                                                        return buildSingleParameterFunction(Functions.RASPIDIGITAL, InternTokenType.NUMBER, AppEventsConstants.EVENT_PARAM_VALUE_NO);
                                                                    case R.string.formula_editor_function_round:
                                                                        return buildSingleParameterFunction(Functions.ROUND, InternTokenType.NUMBER, AppEventsConstants.EVENT_PARAM_VALUE_NO);
                                                                    default:
                                                                        switch (resource) {
                                                                                                                                            ...
                                                                                                                                            default:
                                                                                                                                                switch (resource) {
                                                                                                                                                    ...
                                                                                                                                                    case R.string.formula_editor_function_abs:
                                                                                                                                                        return buildSingleParameterFunction(Functions.ABS, InternTokenType.NUMBER, AppEventsConstants.EVENT_PARAM_VALUE_NO);
                                                                                                                                                    case R.string.formula_editor_function_arccos:
                                                                                                                                                        return buildSingleParameterFunction(Functions.ARCCOS, InternTokenType.NUMBER, AppEventsConstants.EVENT_PARAM_VALUE_NO);
                                                                                                                                                    case R.string.formula_editor_function_arcsin:
                                                                                                                                                        return buildSingleParameterFunction(Functions.ARCSIN, InternTokenType.NUMBER, AppEventsConstants.EVENT_PARAM_VALUE_NO);
                                                                                                                                                    case R.string.formula_editor_function_arctan:
                                                                                                                                                        return buildSingleParameterFunction(Functions.ARCTAN, InternTokenType.NUMBER, AppEventsConstants.EVENT_PARAM_VALUE_NO);
                                                                                                                                                    ...
                                                                                                                                                    case R.string.formula_editor_function_contains:
                                                                                                                                                        return buildDoubleParameterFunction(Functions.CONTAINS, InternTokenType.USER_LIST, "list name", InternTokenType.NUMBER, AppEventsConstants.EVENT_PARAM_VALUE_YES);
                                                                                                                                                    case R.string.formula_editor_function_cos:
                                                                                                                                                        return buildSingleParameterFunction(Functions.COS, InternTokenType.NUMBER, AppEventsConstants.EVENT_PARAM_VALUE_NO);
                                                                                                                                                    case R.string.formula_editor_function_exp:
                                                                                                                                                        return buildSingleParameterFunction(Functions.EXP, InternTokenType.NUMBER, AppEventsConstants.EVENT_PARAM_VALUE_YES);
                                                                                                                                                    ...
                                                                                                                                                    case R.string.formula_editor_function_letter:
                                                                                                                                                        return buildDoubleParameterFunction(Functions.LETTER, InternTokenType.NUMBER, AppEventsConstants.EVENT_PARAM_VALUE_YES, InternTokenType.STRING, "hello world");
                                                                                                                                                    case R.string.formula_editor_function_list_item:
                                                                                                                                                        return buildDoubleParameterFunction(Functions.LIST_ITEM, InternTokenType.NUMBER, AppEventsConstants.EVENT_PARAM_VALUE_YES, InternTokenType.USER_LIST, "list name");
                                                                                                                                                    case R.string.formula_editor_function_ln:
                                                                                                                                                        return buildSingleParameterFunction(Functions.LN, InternTokenType.NUMBER, AppEventsConstants.EVENT_PARAM_VALUE_NO);
                                                                                                                                                    case R.string.formula_editor_function_log:
                                                                                                                                                        return buildSingleParameterFunction(Functions.LOG, InternTokenType.NUMBER, AppEventsConstants.EVENT_PARAM_VALUE_NO);
                                                                                                                                                    case R.string.formula_editor_function_max:
                                                                                                                                                        return buildDoubleParameterFunction(Functions.MAX, InternTokenType.NUMBER, AppEventsConstants.EVENT_PARAM_VALUE_NO, InternTokenType.NUMBER, AppEventsConstants.EVENT_PARAM_VALUE_YES);
                                                                                                                                                    case R.string.formula_editor_function_min:
                                                                                                                                                        return buildDoubleParameterFunction(Functions.MIN, InternTokenType.NUMBER, AppEventsConstants.EVENT_PARAM_VALUE_NO, InternTokenType.NUMBER, AppEventsConstants.EVENT_PARAM_VALUE_YES);
                                                                                                                                                    case R.string.formula_editor_function_mod:
                                                                                                                                                        return buildDoubleParameterFunction(Functions.MOD, InternTokenType.NUMBER, AppEventsConstants.EVENT_PARAM_VALUE_YES, InternTokenType.NUMBER, AppEventsConstants.EVENT_PARAM_VALUE_YES);
                                                                                                                                                    ...
                                                                                                                                                    case R.string.formula_editor_function_power:
                                                                                                                                                        return buildDoubleParameterFunction(Functions.POWER, InternTokenType.NUMBER, "2", InternTokenType.NUMBER, "3");
                                                                                                                                                    case R.string.formula_editor_function_rand:
                                                                                                                                                        return buildDoubleParameterFunction(Functions.RAND, InternTokenType.NUMBER, AppEventsConstants.EVENT_PARAM_VALUE_NO, InternTokenType.NUMBER, AppEventsConstants.EVENT_PARAM_VALUE_YES);
                                                                                                                                                    case R.string.formula_editor_function_sin:
                                                                                                                                                        return buildSingleParameterFunction(Functions.SIN, InternTokenType.NUMBER, AppEventsConstants.EVENT_PARAM_VALUE_NO);
                                                                                                                                                    case R.string.formula_editor_function_sqrt:
                                                                                                                                                        return buildSingleParameterFunction(Functions.SQRT, InternTokenType.NUMBER, AppEventsConstants.EVENT_PARAM_VALUE_NO);
                                                                                                                                                    case R.string.formula_editor_function_tan:
                                                                                                                                                        return buildSingleParameterFunction(Functions.TAN, InternTokenType.NUMBER, AppEventsConstants.EVENT_PARAM_VALUE_NO);
    ...
    private List<InternToken> buildDoubleParameterFunction(Functions function, InternTokenType firstParameter, String firstParameterNumberValue, InternTokenType secondParameter, String secondParameterNumberValue) {
        List<InternToken> returnList = new LinkedList();
    ...
    private List<InternToken> buildSingleParameterFunction(Functions function, InternTokenType firstParameter, String parameterNumberValue) {
        List<InternToken> returnList = new LinkedList();
        returnList.add(new InternToken(InternTokenType.FUNCTION_NAME, function.name()));
        returnList.add(new InternToken(InternTokenType.FUNCTION_PARAMETERS_BRACKET_OPEN));
