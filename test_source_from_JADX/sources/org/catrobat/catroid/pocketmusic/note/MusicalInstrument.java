...
public enum MusicalInstrument {
    ...
    SYNTH_DRUM(119),
    REVERSE_CYMBAL(120),
    GUITAR_FRET_NOISE(ReportFirmwareVersionMessage.COMMAND),
    BREATH_NOISE(SamplingIntervalMessage.COMMAND),
    SEASHORE(123),
    BIRD_TWEET(124),
    TELEPHONE_RING(125),
    HELICOPTER(126),
    APPLAUSE(MetaEvent.SEQUENCER_SPECIFIC),
    GUNSHOT(128);
    ...
    public static MusicalInstrument getInstrumentFromProgram(int program) {
        MusicalInstrument[] instruments = values();
